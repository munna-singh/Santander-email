...
! function (n) {
    ...
    function a(t, e) {
        return n[e] || (n[e] = new RegExp(Tt(e), "g")), "string" == typeof t && "." !== e ? t.replace(/\./g, "")
            .replace(n[e], ".") : t
    }
    ...
    var g, y, e, t, I = function (T) {
            this.$ = function (t, e) {
                ...
                var i = this.api(!0);
                null === e || e === z ? i.search(t, n, o, a) : i.column(e)
                    .search(t, n, o, a), i.draw()
            }, this.fnGetData = function (t, e) {
                var n = this.api(!0);
                if (t === z) return n.data()
                    .toArray();
                var o = t.nodeName ? t.nodeName.toLowerCase() : "";
                return e !== z || "td" == o || "th" == o ? n.cell(t, e)
                    .data() : n.row(t)
                    .data() || null
                ...
                this.api(!0)
                    .order.listener(t, e, n)
            }, this.fnUpdate = function (t, e, n, o, r) {
                var a = this.api(!0);
                return n === z || null === n ? a.row(e)
                    .data(t) : a.cell(e, n)
                    .data(t), r !== z && !r || a.columns.adjust(), o !== z && !o || a.draw(), 0
            ...
            return this.each(function () {
                ...
                if ("table" == this.nodeName.toLowerCase()) {
                    ...
                    var m = u.asStripeClasses,
                        b = d.children("tbody")
                        .find("tr")
                        .eq(0); - 1 !== W.inArray(!0, W.map(m, function (t, e) {
                        return b.hasClass(t)
                    })) && (W("tbody tr", this)
                        .removeClass(m.join(" ")), u.asDestroyStripes = m.slice());
                    var g, v = [],
                    ...
                    var x = u.oFeatures,
                        _ = function () {
                            ...
                            var e = d.children("caption")
                                .each(function () {
                                    this._captionSide = W(this)
                                        .css("caption-side")
                                }),
                                n = d.children("thead");
                            0 === n.length && (n = W("<thead/>")
                                .appendTo(d)), u.nTHead = n[0];
                            var o = d.children("tbody");
                            0 === o.length && (o = W("<tbody/>")
                                .appendTo(d)), u.nTBody = o[0];
                            var r = d.children("tfoot");
                            if (0 === r.length && 0 < e.length && ("" !== u.oScroll.sX || "" !== u.oScroll.sY) && (r = W("<tfoot/>")
                                    .appendTo(d)), 0 === r.length || 0 === r.children()
                                .length ? d.addClass(f.sNoFooter) : 0 < r.length && (u.nTFoot = r[0], ct(u.aoFooter, u.nTFoot)), i.aaData)
                                for (s = 0; s < i.aaData.length; s++) q(u, i.aaData[s]);
                            else !u.bDeferLoading && "dom" != pe(u) || E(u, W(u.nTBody)
                                .children("tr"));
        ...
        w = function (t) {
            if (function (t) {
                    ...
                    for (var e = t.slice()
                            .sort(), n = e[0], o = 1, r = e.length; o < r; o++) {
                        if (e[o] === n) return !1;
                        n = e[o]
                    }
                    return !0
    ...
    function L(t) {
        if (!I.__browser) {
            ...
            var n = W("<div/>")
                ...
                o = n.children(),
                r = o.children();
            e.barWidth = o[0].offsetWidth - o[0].clientWidth, e.bScrollOversize = 100 === r[0].offsetWidth && 100 !== o[0].clientWidth, e.bScrollbarLeft = 1 !== Math.round(r.offset()
                    .left), e.bBounding = !!n[0].getBoundingClientRect()
                .width, n.remove()
        }
    ...
    function H(t, e) {
        ...
        a[o] = W.extend({}, I.models.oSearch, a[o]), B(t, o, W(e)
            .data())
    }
    ...
    function S(t) {
        ...
        for (e = 0, n = c.length; e < n; e++)
            if (d = [], !(s = c[e])
                .sType && s._sManualType) s.sType = s._sManualType;
            else if (!s.sType) {
    ...
    function P(t, e, n, o) {
        ...
        if (e)
            for (r = e.length - 1; 0 <= r; r--) {
                var f = (c = e[r])
                    .targets !== z ? c.targets : c.aTargets;
                for (W.isArray(f) || (f = [f]), i = 0, s = f.length; i < s; i++)
                    ...
                    for (l = 0, d = u.length; l < d; l++) "_all" != f[i] && !W(u[l].nTh)
                        .hasClass(f[i]) || o(l, c)
            }
        if (n)
        ...
        var p = function (t, e, n) {
            for (var o, r, a, i, s, l = J(n), d = l[l.length - 1], c = 0, u = l.length - 1; c < u; c++) {
                if (r = l[c].match(U), a = l[c].match(G), r) {
                    if (l[c] = l[c].replace(U, ""), t[l[c]] = [], (o = l.slice())
                        .splice(0, c + 1), s = o.join("."), W.isArray(e))
    ...
    function et(n, o, t, e) {
        ...
        } else s._aData = nt(n, s, e, e === z ? z : s._aData)
            .data;
    ...
    function ot(t, e, n, o) {
        var r, a, i, s, l, d = t.aoData[e],
            ...
            u = [];
        if (null === d.nTr) {
            for (r = n || v.createElement("tr"), d.nTr = r, d.anCells = u, r._DT_RowIndex = e, rt(t, d), s = 0, l = t.aoColumns.length; s < l; s++) i = t.aoColumns[s], (a = n ? o[s] : v.createElement(i.sCellType))
                ._DT_CellIndex = {
                    row: e,
                    column: s
    ...
    function rt(t, e) {
        ...
        if (n) {
            ...
            if (r && (n.id = r), o.DT_RowClass) {
                ...
                e.__rowc = e.__rowc ? w(e.__rowc.concat(a)) : a, W(n)
                    .removeClass(e.__rowc.join(" "))
                    .addClass(o.DT_RowClass)
            }
            o.DT_RowAttr && W(n)
                .attr(o.DT_RowAttr), o.DT_RowData && W(n)
                .data(o.DT_RowData)
        }
    }
    ...
    function at(t) {
        var e, n, o, r, a, i = t.nTHead,
            ...
            c = t.aoColumns;
        for (l && (r = W("<tr/>")
                .appendTo(i)), e = 0, n = c.length; e < n; e++) a = c[e], o = W(a.nTh)
            .addClass(a.sClass), l && o.appendTo(r), t.oFeatures.bSort && (o.addClass(a.sSortingClass), !1 !== a.bSortable && (o.attr("tabindex", t.iTabIndex)
                .attr("aria-controls", t.sTableId), te(t, a.nTh, e))), a.sTitle != o[0].innerHTML && o.html(a.sTitle), he(t, "header")(t, o, a, d);
        if (l && ct(t.aoHeader, i), W(i)
            .find(">tr")
            .attr("role", "row"), W(i)
            .find(">tr>th, >tr>td")
            .addClass(d.sHeaderTH), W(s)
            .find(">tr>th, >tr>td")
            .addClass(d.sFooterTH), null !== s) {
            var u = t.aoFooter[0];
            for (e = 0, n = u.length; e < n; e++)(a = c[e])
                .nTf = u[e].cell, a.sClass && W(a.nTf)
                .addClass(a.sClass)
        }
    }
    ...
    function st(t) {
        ...
        if (-1 === W.inArray(!1, e)) {
            ...
            if (0 !== d.length)
                for (var f = l ? 0 : c, h = l ? t.aoData.length : u, p = f; p < h; p++) {
                    ...
                    if (0 !== a) {
                        var v = r[o % a];
                        b._sRowStripe != v && (W(g)
                            .removeClass(b._sRowStripe)
                            .addClass(v), b._sRowStripe = v)
                    }
            ...
            ue(t, "aoHeaderCallback", "header", [W(t.nTHead)
                .children("tr")[0], Q(t), c, u, d
            ]), ue(t, "aoFooterCallback", "footer", [W(t.nTFoot)
                .children("tr")[0], Q(t), c, u, d
            ]);
            var w = W(t.nTBody);
            w.children()
                .detach(), w.append(W(n)), ue(t, "aoDrawCallback", "draw", [t]), t.bSorted = !1, t.bFiltered = !1, t.bDrawing = !1
        } else qt(t, !1)
    }
    ...
    function pt(t) {
        ...
        n("sEcho", t.iDraw), n("iColumns", s), n("sColumns", V(i, "sName")
            .join(",")), n("iDisplayStart", h), n("iDisplayLength", p);
        var m = {
            draw: t.iDraw,
            columns: [],
            order: [],
    ...
    function gt(n) {
        ...
        var d = W("<div/>", {
            ...
            .on("keyup.DT search.DT input.DT paste.DT cut.DT", c ? $t(l, c) : l)
            .on("keypress.DT", function (t) {
                if (13 == t.keyCode) return !1
            })
            .attr("aria-controls", e);
        return W(n.nTable)
            .on("search.dt.DT", function (t, e) {
                if (n === e) try {
    ...
    function Dt(t) {
        ...
        for (n = 0, r = t.aoData.length; n < r; n++)
            if (!(l = t.aoData[n])
                ._aFilterData) {
                for (i = [], o = 0, a = d.length; o < a; o++)(e = d[o])
                    .bSearchable ? (s = D(t, n, o, "filter"), c[e.sType] && (s = c[e.sType](s)), null === s && (s = ""), "string" != typeof s && s.toString && (s = s.toString())) : s = "", s.indexOf && -1 !== s.indexOf("&") && (Ct.innerHTML = s, s = St ? Ct.textContent : Ct.innerText), s.replace && (s = s.replace(/[\r\n]/g, "")), i.push(s);
    ...
    function Rt(t) {
        ...
        return n || (t.aoDrawCallback.push({
            ...
            .attr("aria-live", "polite"), W(t.nTable)
            .attr("aria-describedby", e + "_info")), o[0]
    }
    ...
    function At(t) {
        ...
        if (0 !== e.length) {
            ...
            null !== l && (s = l.call(t.oInstance, t, o, r, a, i, s)), W(e)
                .html(s)
        }
    }
    ...
    function kt(t, e) {
        var n = t.fnFormatNumber,
            ...
            i = -1 === r;
        return e.replace(/_START_/g, n.call(t, o))
    ...
    function Nt(n) {
        var o, t, e, r = n.iInitDisplayStart,
            ...
            s = n.bDeferLoading;
        if (n.bInitialised) {
            for (dt(n), at(n), it(n, n.aoHeader), it(n, n.aoFooter), qt(n, !0), i.bAutoWidth && Vt(n), o = 0, t = a.length; o < t; o++)(e = a[o])
                .sWidth && (e.nTh.style.width = Jt(e.sWidth));
    ...
    function Bt(o) {
        ...
        var c = W("<div><label/></div>")
            .addClass(t.sLength);
        return o.aanFeatures.l || (c[0].id = e + "_length"), c.children()
            .append(o.oLanguage.sLengthMenu.replace("_MENU_", s[0].outerHTML)), W("select", c)
            .val(o._iDisplayLength)
            .on("change.DT", function (t) {
                Ht(o, W(this)
                    .val()), st(o)
            }), W(o.nTable)
            .on("length.dt.DT", function (t, e, n) {
                o === e && W("select", c)
                    .val(n)
            }), c[0]
    }
    ...
    function Ot(t) {
        ...
        var e = t.sPaginationType,
            ...
            f = "function" == typeof u,
            n = W("<div/>")
            .addClass(t.oClasses.sPaging + e)[0],
            h = t.aanFeatures;
    ...
    function qt(t, e) {
        t.oFeatures.bProcessing && W(t.aanFeatures.r)
            .css("display", e ? "block" : "none"), ue(t, null, "processing", [t, e])
    }
    ...
    function Et(t) {
        ...
        var p = h.children(),
            ...
            g = u ? p[2] : null;
        return r && W(b)
            .on("scroll.DT", function (t) {
                var e = this.scrollLeft;
                m.scrollLeft = e, u && (g.scrollLeft = e)
            }), W(b)
            .css(a && n.bCollapse ? "max-height" : "height", a), t.nScrollHead = m, t.nScrollBody = b, t.nScrollFoot = g, t.aoDrawCallback.push({
                fn: Mt,
                sName: "scrolling"
            }), h[0]
    }
    ...
    function Mt(n) {
        ...
        n.scrollBarVis = P, I.children("thead, tfoot")
            .remove(), A && (s = A.clone()
                .prependTo(I), o = A.find("tr"), a = s.find("tr")), i = D.clone()
            .prependTo(I), e = D.find("tr"), r = i.find("tr"), i.find("th, td")
            .removeAttr("tabindex"), f || (T.width = "100%", b[0].style.width = "100%"), W.each(ut(n, i), function (t, e) {
                l = X(n, t), e.style.width = n.aoColumns[l].sWidth
            }), A && Wt(function (t) {
                t.style.width = ""
            }, a), c = I.outerWidth(), "" === f ? (R.width = "100%", N && (I.find("tbody")
                .height() > x.offsetHeight || "scroll" == _.css("overflow-y")) && (R.width = Jt(I.outerWidth() - m)), c = I.outerWidth()) : "" !== h && (R.width = Jt(h), c = I.outerWidth()), Wt(t, r), Wt(function (t) {
                O.push(t.innerHTML), H.push(Jt(W(t)
                    .css("width")))
            }, r), Wt(function (t, e) {
                -1 !== W.inArray(t, L) && (t.style.width = H[e])
            }, e), W(r)
            .height(0), A && (Wt(t, a), Wt(function (t) {
                    j.push(t.innerHTML), B.push(Jt(W(t)
                        .css("width")))
                }, a), Wt(function (t, e) {
                    t.style.width = B[e]
                }, o), W(a)
                .height(0)), Wt(function (t, e) {
        ...
        y[M] = E ? m + "px" : "0px", A && (S[0].style.width = Jt(q), C[0].style.width = Jt(q), C[0].style[M] = E ? m + "px" : "0px"), I.children("colgroup")
            .insertBefore(I.children("thead")), _.scroll(), !n.bSorted && !n.bFiltered || n._drawHold || (x.scrollTop = 0)
    }
    ...
    function Vt(t) {
        var e, n, o, r = t.nTable,
            ...
            g = b.bScrollOversize,
            v = r.style.width;
        for (v && -1 !== v.indexOf("%") && (h = v), e = 0; e < u.length; e++) null !== (n = a[u[e]])
            .sWidth && (n.sWidth = Xt(n.sWidthOrig, p), m = !0);
        if (g || !m && !l && !s && c == O(t) && c == f.length)
            for (e = 0; e < c; e++) {
                var y = X(t, e);
                null !== y && (a[y].sWidth = Jt(f.eq(e)
                    .width()))
            } else {
                var w = W(r)
                    .clone()
                ...
                w.find("tbody tr")
                    .remove();
                var x = W("<tr/>")
                    .appendTo(w.find("tbody"));
                for (w.find("thead, tfoot")
                    .remove(), w.append(W(t.nTHead)
                        .clone())
                    .append(W(t.nTFoot)
                        .clone()), w.find("tfoot th, tfoot td")
                    .css("width", ""), f = ut(t, w.find("thead")[0]), e = 0; e < u.length; e++) n = a[u[e]], f[e].style.width = null !== n.sWidthOrig && "" !== n.sWidthOrig ? Jt(n.sWidthOrig) : "", n.sWidthOrig && l && W(f[e])
                    .append(W("<div/>")
                        .css({
                            width: n.sWidthOrig,
                            margin: 0,
                ...
                if (t.aoData.length)
                    for (e = 0; e < u.length; e++) n = a[o = u[e]], W(Ut(t, o))
                        .clone(!1)
                ...
                for (e = 0; e < u.length; e++) {
                    var C = W(f[e]),
                        ...
                        D = b.bBounding ? Math.ceil(f[e].getBoundingClientRect()
                            .width) : C.outerWidth();
        ...
        if (h && (r.style.width = Jt(h)), (h || l) && !t._reszEvt) {
            var I = function () {
                W(F)
                    .on("resize.DT-" + t.sInstance, $t(function () {
                        $(t)
                    }))
            };
    ...
    function Ut(t, e) {
        ...
        if (n < 0) return null;
        var o = t.aoData[n];
        return o.nTr ? o.anCells[e] : W("<td/>")
            .html(D(t, n, e, "display"))[0]
    }

    function Gt(t, e) {
        for (var n, o = -1, r = -1, a = 0, i = t.aoData.length; a < i; a++)(n = (n = (n = D(t, a, e, "display") + "")
                    .replace(zt, ""))
                .replace(/&nbsp;/g, " "))
    ...
    function Kt(t) {
        ...
        for (W.isArray(u) && e(u), f && u.pre && e(u.pre), e(t.aaSorting), f && u.post && e(u.post), n = 0; n < h.length; n++)
            for (o = 0, r = (a = c[l = h[n][0]].aDataSort)
                .length; o < r; o++) s = c[i = a[o]].sType || "string", h[n]._idx === z && (h[n]._idx = W.inArray(h[n][1], c[i].asSorting)), d.push({
                src: l,
                col: i,
                dir: h[n][1],
                index: h[n]._idx,
    ...
    function Yt(t) {
        var e, n, o, r, c, u = [],
            ...
            a = (t.aoColumns, 0),
            i = t.aiDisplayMaster;
        for (S(t), e = 0, n = (c = Kt(t))
            .length; e < n; e++)(r = c[e])
            .formatter && a++, ne(t, r.col);
        if ("ssp" != pe(t) && 0 !== c.length) {
            ...
            a === c.length ? i.sort(function (t, e) {
                ...
                for (r = 0; r < s; r++)
                    if (0 != (a = (n = l[(i = c[r])
                            .col]) < (o = d[i.col]) ? -1 : o < n ? 1 : 0)) return "asc" === i.dir ? a : -a;
                ...
                for (r = 0; r < s; r++)
                    if (n = l[(i = c[r])
                            .col], o = d[i.col], 0 !== (a = (f[i.type + "-" + i.dir] || f["string-" + i.dir])(n, o))) return a;
                return (n = u[t]) < (o = u[e]) ? -1 : o < n ? 1 : 0
            })
        }
        t.bSorted = !0
    ...
    function ee(t) {
        ...
        if (s.bSort && s.bSortClasses) {
            for (e = 0, n = r.length; e < n; e++) o = r[e].src, W(V(t.aoData, "anCells", o))
                .removeClass(a + (e < 2 ? e + 1 : 3));
            for (e = 0, n = i.length; e < n; e++) o = i[e].src, W(V(t.aoData, "anCells", o))
                .addClass(a + (e < 2 ? e + 1 : 3))
        }
        t.aLastSort = i
    }
    ...
    function ne(t, e) {
        ...
        for (var s = I.ext.type.order[a.sType + "-pre"], l = 0, d = t.aoData.length; l < d; l++)(o = t.aoData[l])
            ._aSortData || (o._aSortData = []), o._aSortData[e] && !i || (r = i ? n[l] : D(t, l, e, "sort"), o._aSortData[e] = s ? s(r) : r)
    }
    ...
    y = function (t, e) {
        ...
        function n(t) {
            var e = function (t) {
                ...
                return t ? t.nTable && t.oApi ? [t] : t.nodeName && "table" === t.nodeName.toLowerCase() ? -1 !== (e = W.inArray(t, r)) ? [o[e]] : null : t && "function" == typeof t.settings ? t.settings()
                    .toArray() : ("string" == typeof t ? n = W(t) : t instanceof W && (n = t), n ? n.map(function (t) {
        ...
        if (n.length && e && (e instanceof y || e.__dt_wrapper)) {
            ...
            for (o = 0, r = n.length; o < r; o++) e[(a = n[o])
                .name] = "function" == typeof a.val ? i(t, a.val, a) : W.isPlainObject(a.val) ? {} : a.val, e[a.name].__dt_wrapper = !0, y.extend(t, e[a.name], a.propExt)
        }
    ...
    e("tables()", function (t) {
        ...
        return e === z ? this.page.info()
            .page : this.iterator("table", function (t) {
                jt(t, e)
            })
    ...
    e("ajax.json()", function () {
        ...
        var t = this.context;
        return e === z ? 0 === t.length ? z : (t = t[0])
            .ajax ? W.isPlainObject(t.ajax) ? t.ajax.url : t.ajax : t.sAjaxSource : this.iterator("table", function (t) {
    ...
    function ve(t, e, n, o, r) {
        ...
        for (e && "string" != f && "function" != f && e.length !== z || (e = [e]), s = 0, l = e.length; s < l; s++)
            for (d = 0, c = (i = e[s] && e[s].split && !e[s].match(/[\[\(:]/) ? e[s].split(",") : [e[s]])
                .length; d < c; d++)(a = n("string" == typeof i[d] ? W.trim(i[d]) : i[d])) && a.length && (u = u.concat(a));
        var h = g.selector[t];
        if (h.length)
    ...
    function ye(t) {
        return (t = t || {})
            .filter && t.search === z && (t.search = t.filter), W.extend({
                search: "none",
                order: "current",
                page: "all"
            }, t)
    ...
    e("rows()", function (e, n) {
        ...
        return this.iterator("row", function (t, e, n) {
            ...
            for (d.splice(e, 1), o = 0, r = d.length; o < r; o++)
                if (l = (s = d[o])
                    .anCells, null !== s.nTr && (s.nTr._DT_RowIndex = o), null !== l)
        ...
        var t = this.iterator("table", function (t) {
                var e, n, o, r = [];
                for (n = 0, o = a.length; n < o; n++)(e = a[n])
                    .nodeName && "TR" === e.nodeName.toUpperCase() ? r.push(E(t, e)[0]) : r.push(q(t, e));
                return r
            }, 1),
            e = this.rows(-1);
    ...
    var Ce = function (l) {
            var r = new y(l),
                ...
                o = "destroy" + t,
                d = l.aoData;
            r.off(e + " " + n + " " + o), 0 < V(d, "_details")
                .length && (r.on(e, function (t, e) {
                    l === e && r.rows({
                            page: "current"
                        })
                        .eq(0)
                    ...
                    if (l === e)
                        for (var r, a = O(e), i = 0, s = d.length; i < s; i++)(r = d[i])
                            ._details && r._details.children("td[colspan]")
                            .attr("colspan", a)
                }), r.on(o, function (t, e) {
                    if (l === e)
            ...
            var i = [],
                s = function (t, e) {
                    if (W.isArray(t) || t instanceof W)
                        ...
                        W("td", r)
                            .addClass(e)
                            .html(t)[0].colSpan = O(a), i.push(r[0])
                    }
                };
        ...
        var t = this.iterator("column", function (t, e) {
            ...
            ! function (t, e, n) {
                ...
                if (l.bVisible !== n) {
                    ...
                    } else W(V(t.aoData, "anCells", e))
                        .detach();
                    l.bVisible = n, it(t, t.aoHeader), it(t, t.aoFooter), t.aiDisplay.length || W(t.nTBody)
                        .find("td[colspan]")
                        .attr("colspan", O(t)), oe(t)
                }
            }(t, e, n)
        });
    ...
    e("cells()", function (e, t, n) {
            ...
            return function (o, t, e) {
                ...
                return ve("cell", t, function (t) {
                    ...
                    var n = h.filter(t)
                        ...
                        .toArray();
                    return n.length || !t.nodeName ? n : (c = W(t)
                            .closest("*[data-dt-row]"))
                        .length ? [{
                            row: c.data("dt-row"),
        ...
        return p = p || !1, this.iterator("table", function (e) {
            ...
            e.bDestroying = !0, ue(e, "aoDestroyCallback", "destroy", [e]), p || new y(e)
                .columns()
                .visible(!0), c.off(".DT")
                .find(":not(tbody *)")
                .off(".DT"), W(F)
                .off(".DT-" + e.sInstance), r != i.parentNode && (l.children("thead")
                    .detach(), l.append(i)), s && r != s.parentNode && (l.children("tfoot")
                    .detach(), l.append(s)), e.aaSorting = [], e.aaSortingFixed = [], ee(e), W(u)
                .removeClass(e.asStripeClasses.join(" ")), W("th, td", i)
                .removeClass(o.sSortable + " " + o.sSortableAsc + " " + o.sSortableDesc + " " + o.sSortableNone), d.children()
                .detach(), d.append(u);
            var f = p ? "remove" : "detach";
            l[f](), c[f](), !p && t && (t.insertBefore(r, e.nTableReinsertBefore), l.css("width", e.sDestroyWidth)
                .removeClass(o.sTable), (n = e.asDestroyStripes.length) && d.children()
                .each(function (t) {
                    W(this)
                        .addClass(e.asDestroyStripes[t % n])
                }));
        ...
        fnStateLoadCallback: function (t) {
            try {
                return JSON.parse((-1 === t.iStateDuration ? sessionStorage : localStorage)
        ...
        fnStateSaveCallback: function (t, e) {
            try {
                (-1 === t.iStateDuration ? sessionStorage : localStorage)
                .setItem("DataTables_" + t.sInstance + "_" + location.pathname, JSON.stringify(e))
            } catch (t) {}
        },
    ...
    function Ae(t, e) {
        var n = [],
            o = Re.numbers_length,
            r = Math.floor(o / 2);
        return e <= o ? n = p(0, e) : t <= r ? ((n = p(0, o - 2))
            .push("ellipsis"), n.push(e - 1)) : (e - 1 - r <= t ? (n = p(e - (o - 2), e))
            .splice(0, 0, "ellipsis") : ((n = p(t - r + 2, t + r - 1))
                .push("ellipsis"), n.push(e - 1), n.splice(0, 0, "ellipsis")), n.splice(0, 0, 0)), n.DT_el = "span", n
    }
    W.extend(Re, {
        simple: function (t, e) {
        ...
        html: function (t) {
            return r(t) ? t : "string" == typeof t ? t.replace(s, " ")
                .replace(l, "") : ""
        },
        string: function (t) {
    ...
    W.extend(g.type.order, {
        ...
        "html-pre": function (t) {
            return r(t) ? "" : t.replace ? t.replace(/<.*?>/g, "")
                .toLowerCase() : t + ""
        },
        ...
        header: {
            _: function (a, i, s, l) {
                W(a.nTable)
                    .on("order.dt.DT", function (t, e, n, o) {
                        if (a === e) {
                            var r = s.idx;
                            i.removeClass(s.sSortingClass + " " + l.sSortAsc + " " + l.sSortDesc)
                                .addClass("asc" == o[r] ? l.sSortAsc : "desc" == o[r] ? l.sSortDesc : s.sSortingClass)
                        }
                    })
            },
            jqueryui: function (a, i, s, l) {
                W("<div/>")
                    ...
                    .append(i.contents())
                    .append(W("<span/>")
                        .addClass(l.sSortIcon + " " + s.sSortingClassJUI))
                    .appendTo(i), W(a.nTable)
                    .on("order.dt.DT", function (t, e, n, o) {
                        if (a === e) {
                            var r = s.idx;
                            i.removeClass(l.sSortAsc + " " + l.sSortDesc)
                                .addClass("asc" == o[r] ? l.sSortAsc : "desc" == o[r] ? l.sSortDesc : s.sSortingClass), i.find("span." + l.sSortIcon)
                                .removeClass(l.sSortJUIAsc + " " + l.sSortJUIDesc + " " + l.sSortJUI + " " + l.sSortJUIAscAllowed + " " + l.sSortJUIDescAllowed)
                                .addClass("asc" == o[r] ? l.sSortJUIAsc : "desc" == o[r] ? l.sSortJUIDesc : s.sSortingClassJUI)
                        }
                    })
            }
        }
    ...
    return I.render = {
                ...
                return {
                    display: function (t) {
                        ...
                        var o = parseInt(t, 10),
                            ...
                            .toFixed(s)
                            .substring(2) : "";
                        return e + (l || "") + o.toString()
                            .replace(/\B(?=(\d{3})+(?!\d))/g, a) + r + (d || "")
                    }
                }
            },
            text: function () {
            ...
            .$ = W)
        .fn.dataTableSettings = I.settings, W.fn.dataTableExt = I.ext, W.fn.DataTable = function (t) {
            return W(this)
                .dataTable(t)
                .api()
...
function (n) {
    ...
    return y.extend(!0, a.defaults, {
        ...
        var u, f, n, h = new a.Api(s),
            ...
            v = function (t, e) {
                function n(t) {
                    t.preventDefault(), y(t.currentTarget)
                        .hasClass("disabled") || h.page() == t.data.action || h.page(t.data.action)
                        .draw("page")
                }
                var o, r, a, i;
                for (o = 0, r = e.length; o < r; o++)
                    if (i = e[o], y.isArray(i)) v(t, i);
                        ...
                        u && (a = y("<li>", {
                            ...
                            .append(y("<a>", {
                                ...
                                .html(u))
                            .appendTo(t), s.oApi._fnBindAction(a, {
                                action: i
                            }, n), g++)
                    }
            };
    ...
    function (n) {
        ...
        b.extend(l.prototype, {
            ...
            _constructor: function () {
                var t = this,
                    e = this.s.dt,
                    n = b("div.dataTables_scrollBody", this.s.dt.table()
                        .container());
                e.settings()[0].autoFill = this, n.length && "static" === (this.dom.dtScroll = n)
                    .css("position") && n.css("position", "relative"), !1 !== this.c.enable && this.enable(), e.on("destroy.autoFill", function () {
            ...
            _attach: function (t) {
                var e = this.s.dt,
                    ...
                    o = this.dom.handle,
                    r = this.s.handle;
                if (n && -1 !== e.columns(this.c.columns)
                    .indexes()
                    .indexOf(n.column)) {
                    this.dom.offsetParent || (this.dom.offsetParent = b(e.table()
                            .node())
                        .offsetParent()), r.height && r.width || (o.appendTo("body"), r.height = o.outerHeight(), r.width = o.outerWidth());
            ...
            _actionSelector: function (n) {
                ...
                if (b.each(a, function (t, e) {
                    ...
                    var s = this.dom.list.children("ul")
                        .empty();
                    i.push("cancel"), b.each(i, function (t, e) {
                        s.append(b("<li/>")
                            .append('<div class="dt-autofill-question">' + a[e].option(r, n) + "<div>")
                            .append(b('<div class="dt-autofill-button">')
                                .append(b('<button class="' + l.classes.btn + '">' + r.i18n("autoFill.button", "&gt;") + "</button>")
                                    .on("click", function () {
                                        var t = a[e].execute(r, n, b(this)
                                            .closest("li"));
                ...
                var n = this.s.dt,
                    ...
                    a = {
                        row: this.c.vertical ? n.rows({
                            ...
                            .nodes()
                            .indexOf(t.parentNode) : o.row,
                        column: this.c.horizontal ? b(t)
                            .index() : o.column
                    },
                    ...
                    l = b(n.cell(s.index(), i)
                        .node());
                if (n.cell(l)
                    .any() && -1 !== n.columns(this.c.columns)
                    .indexes()
                    .indexOf(i)) {
                    var d, c, u, f, h, p;
                    this.s.end = a, d = o.row < a.row ? r : l, c = o.row < a.row ? l : r, u = o.column < a.column ? r : l, f = o.column < a.column ? l : r, d = this._getPosition(d.get(0))
                        .top, u = this._getPosition(u.get(0))
                        .left, h = this._getPosition(c.get(0))
                        .top + c.outerHeight() - d, p = this._getPosition(f.get(0))
                        .left + f.outerWidth() - u;
            ...
            _focusListener: function () {
                var o = this,
                    e = this.s.dt,
                    t = this.s.namespace,
                    n = null !== this.c.focus ? this.c.focus : e.init()
                    .keys || e.settings()[0].keytable ? "focus" : "hover";
                "focus" === n ? e.on("key-focus.autoFill", function (t, e, n) {
                    ...
                    .on("mouseleave" + t, function (t) {
                        b(t.relatedTarget)
                            .hasClass("dt-autofill-handle") || o._detach()
                    })
            },
            _focusListenerRemove: function () {
                var t = this.s.dt;
                t.off(".autoFill"), b(t.table()
                        .body())
                    .off(this.s.namespace), b(p.body)
            ...
            _getPosition: function (t, e) {
                var n, o = t,
                    r = 0,
                    a = 0;
                e = e || b(b(this.s.dt.table()
                    .node())[0].offsetParent);
                do {
                    var i = o.offsetTop,
                        s = o.offsetLeft;
                    if (r += i + (n = b(o.offsetParent))
                        .scrollTop(), a += s + n.scrollLeft(), r += 1 * parseInt(n.css("margin-top")), r += 1 * parseInt(n.css("border-top-width")), "body" === o.nodeName.toLowerCase()) break;
                    o = n.get(0)
            ...
            _mousedown: function (t) {
                ...
                this.dom.start = this.dom.attachedTo, this.s.start = {
                        row: n.rows({
                            ...
                            .nodes()
                            .indexOf(b(this.dom.start)
                                .parent()[0]),
                        column: b(this.dom.start)
                            .index()
                    }, b(p.body)
            ...
            _mouseup: function (t) {
                ...
                if (o.row !== r.row || o.column !== r.column) {
                    ...
                    for (var l = this._range(o.row, r.row), d = this._range(o.column, r.column), c = [], u = i.settings()[0], f = u.aoColumns, h = 0; h < l.length; h++) c.push(b.map(d, function (t) {
                        ...
                        return a !== v && (o = u.oApi._fnGetObjectDataFn(a)(i.row(r.row)
                            .data())), {
                            cell: n,
                            data: o,
                            label: n.data(),
            ...
            increment: {
                ...
                execute: function (t, e, n) {
                    for (var o = 1 * e[0][0].data, r = 1 * b("input", n)
                            .val(), a = 0, i = e.length; a < i; a++)
        ...
        return t.register("autoFill()", function () {
            ...
            .on("preInit.dt.autofill", function (t, e, n) {
                if ("dt" === t.namespace) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-autofill"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.AutoFill || require("datatables.net-autofill")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        "use strict";
    ...
    function (n) {
        ...
        var r, o = w.fn.dataTable,
            ...
            T = function (e, t) {
                ...
                void 0 === t && (t = {}), !0 === t && (t = {}), w.isArray(t) && (t = {
                    ...
                    container: w("<" + this.c.dom.container.tag + "/>")
        ...
        w.extend(T.prototype, {
            ...
            disable: function (t) {
                ...
                return w(e.node)
                    .addClass(this.c.dom.button.disabled), this
            },
            destroy: function () {
                w("body")
            ...
            enable: function (t, e) {
                ...
                var n = this._nodeToButton(t);
                return w(n.node)
                    .removeClass(this.c.dom.button.disabled), this
            },
            name: function () {
                return this.c.name
            },
            ...
            processing: function (t, e) {
                var n = this._nodeToButton(t);
                return e === y ? w(n.node)
                    .hasClass("processing") : (w(n.node)
                        .toggleClass("processing", e), this)
            },
            remove: function (t) {
                var e = this._nodeToButton(t),
                ...
                e.conf.destroy && e.conf.destroy.call(o.button(t), o, w(t), e.conf), this._removeKey(e.conf), w(e.node)
                    .remove();
                var a = w.inArray(e, n);
            ...
            text: function (t, e) {
                ...
                var o = this._nodeToButton(t),
                    ...
                    i = this.s.dt,
                    s = w(o.node);
                return e === y ? n(o.conf.text) : (o.conf.text = e, a ? s.children(a)
                    .html(n(e)) : s.html(n(e)), this)
            },
            _constructor: function () {
                var n = this,
                    t = this.s.dt,
                ...
                t.on("destroy", function (t, e) {
                    ...
                    .on("keyup." + this.s.namespace, function (t) {
                        if (!_.activeElement || _.activeElement === _.body) {
                            var e = String.fromCharCode(t.keyCode)
                                .toLowerCase(); - 1 !== n.s.listenKeys.toLowerCase()
                                .indexOf(e) && n._keypress(e, t)
                        }
                    })
            },
            _addKey: function (t) {
            ...
            _draw: function (t, e) {
                t || (t = this.dom.container, e = this.s.buttons), t.children()
                    .detach();
                        ...
                        if (w.isArray(l)) this._expandButton(t, l, n, o);
                            ...
                            if (d) {
                                if (o !== y ? (t.splice(o, 0, d), o++) : t.push(d), d.conf.buttons) {
                                    ...
                                    d.collection = w("<" + c.tag + "/>")
                                        .addClass(c.className)
                                        .attr("role", "menu"), d.conf._collection = d.collection, this._expandButton(d.buttons, d.conf.buttons, !0, o)
                                }
            ...
            _buildButton: function (e, t) {
                ...
                function s(t, e, n, o) {
                    o.action.call(e.button(n), t, e, n, o), w(e.table()
                            .node())
                        .triggerHandler("buttons-action.dt", [e.button(n), e, n, o])
                }
                var l = e.tag || o.tag,
                ...
                return f = h && h.tag ? w("<" + h.tag + "/>")
                    .addClass(h.className)
                    .append(c) : c, this._addKey(e), this.c.buttonCreated && (f = this.c.buttonCreated(e, f)), {
                        conf: e,
                        node: c.get(0),
                        inserter: f,
                        buttons: [],
            ...
            _nodeToButton: function (t, e) {
                for (var n = 0, o = (e = e || this.s.buttons)
                        .length; n < o; n++) {
            ...
            _keypress: function (n, o) {
                if (!o._buttonsHandled) {
                    var r = function (t, e) {
                            if (t.key)
                                if (t.key === n) o._buttonsHandled = !0, w(e)
                                    .click();
            ...
            collection: {
                ...
                action: function (t, e, n, o) {
                    function r() {
                        e.buttons('[aria-haspopup="true"][aria-expanded="true"]')
                            .nodes()
                            .each(function () {
                                var t = w(this)
                                    .siblings(".dt-button-collection");
                                t.length && t.stop()
                                    .fadeOut(o.fade, function () {
                                        t.detach()
                                    }), w(this)
                                    .attr("aria-expanded", "false")
                            }), w("div.dt-button-background")
                            .off("click.dtb-collection"), T.background(!1, o.backgroundClassName, o.fade, u), w("body")
                            .off(".dtb-collection"), e.off("buttons-action.b-internal")
                    }
                    var a = "true" === n.attr("aria-expanded");
                    if (r(), !a) {
                        var i = n,
                            s = w(n)
                            .parents("div.dt-button-collection"),
                            l = i.position(),
                            d = w(e.table()
                                .container()),
                            c = !1,
                            u = i;
                        n.attr("aria-expanded", "true"), s.length && (c = w(".dt-button-collection")
                                .position(), u = s, w("body")
                                .trigger("click.dtb-collection")), u.parents("body")[0] !== _.body && (u = _.body.lastChild), o._collection.find(".dt-button-collection-title")
                            .remove(), o._collection.prepend('<div class="dt-button-collection-title">' + o.collectionTitle + "</div>"), o._collection.addClass(o.collectionLayout)
                            .css("display", "none")
                            .insertAfter(u)
                            .stop()
                            .fadeIn(o.fade);
                        ...
                        if (c && "absolute" === f) o._collection.css({
                            ...
                            (d.offset()
                                .top - m < p || o.dropup) && o._collection.css("top", l.top - o._collection.outerHeight() - 5), o._collection.hasClass(o.rightAlignClassName) && o._collection.css("left", l.left + i.outerWidth() - o._collection.outerWidth());
                            var b = l.left + o._collection.outerWidth(),
                                g = d.offset()
                                .left + d.width();
                            g < b && o._collection.css("left", l.left - (b - g));
                            var v = i.offset()
                                .left + o._collection.outerWidth();
                            v > w(x)
                                .width() && o._collection.css("left", l.left - (v - w(x)
                                    .width()))
                        } else {
                            var y = o._collection.height() / 2;
                            y > w(x)
                                .height() / 2 && (y = w(x)
                                    .height() / 2), o._collection.css("marginTop", -1 * y)
                        }
                        o.background && T.background(!0, o.backgroundClassName, o.fade, u), setTimeout(function () {
                            w("div.dt-button-background")
                                .on("click.dtb-collection", function () {}), w("body")
                                .on("click.dtb-collection", function (t) {
                                    var e = w.fn.addBack ? "addBack" : "andSelf";
                                    w(t.target)
                                        .parents()[e]()
                                        .filter(o._collection)
                                        .length || r()
                                })
            ...
            var o = this;
            return !1 === t ? (w("#datatables_buttons_info")
                .fadeOut(function () {
                    w(this)
                        .remove()
                }), clearTimeout(r), r = null) : (r && clearTimeout(r), w("#datatables_buttons_info")
                .length && w("#datatables_buttons_info")
                .remove(), t = t ? "<h2>" + t + "</h2>" : "", w('<div id="datatables_buttons_info" class="dt-button-info"/>')
                .html(t)
                .append(w("<div/>")["string" == typeof e ? "html" : "append"](e))
                .css("display", "none")
                .appendTo("body")
                .fadeIn(), n !== y && 0 !== n && (r = setTimeout(function () {
                    o.buttons.info(!1)
                }, n))), this
        ...
        var e = function (t) {
                ...
                if ("function" == typeof e && (e = e()), e === y || null === e) return null; - 1 !== e.indexOf("*") && (e = w.trim(e.replace("*", w("head > title")
                    .text()))), e = e.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "");
                var n = a(t.extension);
                return e + (n = n || "")
            },
            a = function (t) {
            ...
            i = function (t) {
                var e = a(t.title);
                return null === e ? null : -1 !== e.indexOf("*") ? e.replace("*", w("head > title")
                    .text() || "Exported data") : e
            },
            s = function (t, e, n) {
                var o = a(e);
                if (null === o) return null;
                var r = w("caption", t.table()
                        .container())
                    .eq(0);
            ...
            l = function (n, t) {
                var o = w.extend(!0, {}, {
                    ...
                    e = function (t) {
                        return "string" != typeof t || (t = (t = t.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, ""))
                            .replace(/<!\-\-.*?\-\->/g, ""), o.stripHtml && (t = t.replace(/<[^>]*>/g, "")), o.trim && (t = t.replace(/^\s+|\s+$/g, "")), o.stripNewlines && (t = t.replace(/\n/g, " ")), o.decodeEntities && (C.innerHTML = t, t = C.value)), t
                    },
                    r = n.columns(o.columns)
                    .indexes()
                    .map(function (t) {
                        var e = n.column(t)
                            .header();
                ...
                for (var s = n.rows(o.rows, i)
                        .indexes()
                        .toArray(), l = n.cells(s, o.columns), d = l.render(o.orthogonal)
                        .toArray(), c = l.nodes()
                        .toArray(), u = r.length, f = [], h = 0, p = 0, m = 0 < u ? d.length / u : 0; p < m; p++) {
        ...
        function t(t) {
            var e = new o.Api(t),
                n = e.init()
                .buttons || o.defaults.buttons;
            return new T(e, n)
                .container()
        }
        return w.fn.dataTable.Buttons = T, w.fn.DataTable.Buttons = T, w(_)
            .on("init.dt plugin-init.dt", function (t, e) {
                if ("dt" === t.namespace) {
                    var n = e.oInit.buttons || o.defaults.buttons;
                    n && !e._buttons && new T(e, n)
                        .container()
                }
            }), o.ext.feature.push({
                fnInit: t,
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-buttons"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.Buttons || require("datatables.net-buttons")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (n, t, e, o) {
        "use strict";
        ...
        return n.extend(!0, r.Buttons.defaults, {
            ...
            buttonCreated: function (t, e) {
                return t.buttons ? n('<div class="btn-group"/>')
                    .append(e) : e
            }
    ...
    function (r) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net")(t, e)
                .$), e.fn.dataTable.Buttons || require("datatables.net-buttons")(t, e), r(e, t, t.document, n, o)
            ...
            if (!(void 0 === s || "undefined" != typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent))) {
                var t = s.document,
                    ...
                    o = function (t, e, n) {
                        ...
                        if (a.readyState = a.INIT, c) return r = l()
                            .createObjectURL(t), void setTimeout(function () {
                        ...
                        ! function () {
                            if ((f || i && u) && s.FileReader) {
                                ...
                                .createObjectURL(t), i) ? s.location.href = r: s.open(r, "_blank") || (s.location.href = r);
        ...
        function g(t, e) {
            for (var n = b(e), o = t.buttons.exportData(e.exportOptions), r = e.fieldBoundary, a = e.fieldSeparator, i = new RegExp(r, "g"), s = e.escapeChar !== I ? e.escapeChar : "\\", l = function (t) {
                    for (var e = "", n = 0, o = t.length; n < o; n++) 0 < n && (e += a), e += r ? r + ("" + t[n])
                        .replace(i, s + r) + r : t[n];
                    return e
        ...
        function H(t, e, n) {
            ...
            return n && (n.attr && D(o)
                .attr(n.attr), n.children && D.each(n.children, function (t, e) {
                    o.appendChild(e)
        ...
        function B(t, e) {
            ...
            for (var i = 0, s = t.body.length; i < s; i++) {
                var l = t.body[i][e];
                if (a < (n = -1 !== (r = null !== l && l !== I ? l.toString() : "")
                        .indexOf("\n") ? ((o = r.split("\n"))
                            .sort(function (t, e) {
        ...
        return o.ext.buttons.copyHtml5 = {
            ...
            action: function (t, e, n, o) {
                ...
                var c = D("<textarea readonly/>")
                    .val(l)
                    .appendTo(d);
                if (m.queryCommandSupported("copy")) {
                    d.appendTo(e.table()
                        .container()), c[0].focus(), c[0].select();
                    try {
                ...
                var f = D("<span>" + e.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>âŒ˜</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") + "</span>")
                    .append(d);
                e.buttons.info(e.i18n("buttons.copyTitle", "Copy to clipboard"), f, 0), c[0].focus(), c[0].select();

                function h() {
                    p.off("click.buttons-copy"), D(m)
                        .off(".buttons-copy"), e.buttons.info(!1)
                }
                var p = D(f)
                    .closest(".dt-button-info");
                p.on("click.buttons-copy", h), D(m)
            ...
            action: function (t, e, n, u) {
                ...
                function c(t, e) {
                    ...
                    n[0].appendChild(H(m, "mergeCell", {
                        ...
                        })), n.attr("count", parseFloat(n.attr("count")) + 1), D("row:eq(" + (t - 1) + ") c", m)
                        .attr("s", "51")
                }
                var g = e.buttons.exportInfo(u);
                g.title && (r([g.title]), c(p, d.header.length - 1)), g.messageTop && (r([g.messageTop]), c(p, d.header.length - 1)), u.header && (r(d.header), D("row:last c", m)
                    .attr("s", "2")), a = p;
                for (var v = 0, y = d.body.length; v < y; v++) r(d.body[v]);
                i = p, u.footer && d.footer && (r(d.footer), D("row:last c", m)
                    .attr("s", "2")), g.messageBottom && (r([g.messageBottom]), c(p, d.header.length - 1));
                var w = H(m, "cols");
                D("worksheet", m)
                    .prepend(w);
                ...
                D("sheets sheet", T)
                    .attr("name", A(u)), u.autoFilter && (D("mergeCells", m)
                        .before(H(m, "autoFilter", {
                            attr: {
                                ref: "A" + a + ":" + k(d.header.length - 1) + i
                            }
                        })), D("definedNames", T)
                        .append(H(T, "definedName", {
                            attr: {
                        ...
                        }))), u.customize && u.customize(l, u, e), 0 === D("mergeCells", m)
                    .children()
                    .length && D("mergeCells", m)
                    .remove();
                var C = new(F()),
                    S = {
                        type: "blob",
                ...
                ! function c(u, t) {
                    N === I && (N = -1 === L.serializeToString(D.parseXML(O["xl/worksheets/sheet1.xml"]))
                        .indexOf("xmlns:r")), D.each(t, function (t, e) {
                        if (D.isPlainObject(e)) c(u.folder(t), e);
                            ...
                            N && (-1 === d.indexOf("<?xml") && (d = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + d), d = (d = d.replace(/_dt_b_namespace_token_/g, ":"))
                                .replace(/xmlns:NS[\d]+="" NS[\d]+:/g, "")), d = d.replace(/<([^<>]*?) xmlns=""([^<>]*?)>/g, "<$1 $2>"), u.file(t, d)
                        }
                    })
                }(C, l), C.generateAsync ? C.generateAsync(S)
                    .then(function (t) {
        ...
        return e.ext.buttons.print = {
            ...
            action: function (t, e, n, o) {
                ...
                var a = e.buttons.exportData(p.extend({
                    ...
                    i = e.buttons.exportInfo(o),
                    s = e.columns(o.exportOptions.columns)
                    .flatten()
                    .map(function (t) {
                        return e.settings()[0].aoColumns[e.column(t)
                            .index()].sClass
                    })
                    .toArray(),
                    l = '<table class="' + e.table()
                    .node()
                    .className + '">';
                ...
                u.document.body.innerHTML = "<h1>" + i.title + "</h1><div>" + (i.messageTop || "") + "</div>" + l + "<div>" + (i.messageBottom || "") + "</div>", p(u.document.body)
                    .addClass("dt-print-view"), p("img", u.document.body)
                    .each(function (t, e) {
    ...
    function (n) {
        ...
        return i.extend(n.ext.buttons, {
            ...
            columnVisibility: {
                ...
                init: function (o, r, a) {
                    ...
                    r.attr("data-cv-idx", a.columns), o.on("column-visibility.dt" + a.namespace, function (t, e) {
                            e.bDestroying || e.nTable != o.settings()[0].nTable || n.active(o.column(a.columns)
                                .visible())
                        })
                        .on("column-reorder.dt" + a.namespace, function (t, e, n) {
                            1 === o.columns(a.columns)
                                .count() && (a.columns = i.inArray(a.columns, n.mapping), r.attr("data-cv-idx", a.columns), r.parent()
                                    .children("[data-cv-idx]")
                                    .sort(function (t, e) {
                                        return 1 * t.getAttribute("data-cv-idx") - 1 * e.getAttribute("data-cv-idx")
                                    })
                                    .appendTo(r.parent()))
                        }), this.active(o.column(a.columns)
                            .visible())
                },
                destroy: function (t, e, n) {
                    t.off("column-visibility.dt" + n.namespace)
                        .off("column-reorder.dt" + n.namespace)
                },
                _columnText: function (t, e) {
                    var n = t.column(e.columns)
                        .index(),
            ...
            colvisGroup: {
                ...
                action: function (t, e, n, o) {
                    e.columns(o.show)
                        .visible(!0, !1), e.columns(o.hide)
                        .visible(!1, !1), e.columns.adjust()
                },
                show: [],
                hide: []
            }
    ...
    function (n) {
        ...
        w.fn.dataTableExt.oApi.fnColReorder = function (n, t, e, o, r) {
            ...
            if (t != e)
                ...
                for (i = 0, s = h; i < s; i++) {
                    for (l = 0, d = (f = n.aoColumns[i])
                        .aDataSort.length; l < d; l++) f.aDataSort[l] = m[f.aDataSort[l]];
                    f.idx = m[f.idx]
                }
                for (w.each(n.aLastSort, function (t, e) {
                        n.aLastSort[t].src = m[e.src]
                    }), i = 0, s = h; i < s; i++) "number" == typeof (f = n.aoColumns[i])
                    .mData ? f.mData = m[f.mData] : w.isPlainObject(f.mData) && (a(f.mData, "_", m), a(f.mData, "filter", m), a(f.mData, "sort", m), a(f.mData, "type", m));
                if (n.aoColumns[t].bVisible) {
                    ...
                    for (i = 0, s = (u = n.nTHead.getElementsByTagName("tr"))
                        .length; i < s; i++) C(u[i], b, g);
                    if (null !== n.nTFoot)
                        for (i = 0, s = (u = n.nTFoot.getElementsByTagName("tr"))
                            .length; i < s; i++) C(u[i], b, g);
                ...
                for (!r && r !== x || w.fn.dataTable.Api(n)
                    .rows()
                    .invalidate(), i = 0, s = h; i < s; i++) w(n.aoColumns[i].nTh)
                    .off(".DT"), this.oApi._fnSortAttachListener(n, n.aoColumns[i].nTh, i);
                w(n.oInstance)
                    .trigger("column-reorder.dt", [n, {
                        from: t,
                        to: e,
                        mapping: m,
                        drop: o,
        ...
        var s = function (t, e) {
            var n = new w.fn.dataTable.Api(t)
                .settings()[0];
            ...
            return o && (o(s.defaults, s.defaults, !0), o(s.defaults, e || {})), this.s = {
                    ...
                    drag: null,
                    pointer: null
                }, this.s.enable = this.s.init.bEnable, this.s.dt = n, (this.s.dt._colReorder = this)
                ._fnConstruct(), this
        };
        return w.extend(s.prototype, {
                ...
                _fnConstruct: function () {
                    ...
                    w(o)
                        .on("destroy.dt.colReorder", function () {
                            w(o)
                                .off("destroy.dt.colReorder draw.dt.colReorder"), w.each(n.s.dt.aoColumns, function (t, e) {
                                    w(e.nTh)
                                        .off(".ColReorder"), w(e.nTh)
                ...
                _fnOrderColumns: function (t) {
                    ...
                    if (t.length == this.s.dt.aoColumns.length) {
                        ...
                        this._fnSetColumnIndexes(), e && (w.fn.dataTable.Api(this.s.dt)
                            .rows()
                            .invalidate(), "" === this.s.dt.oScroll.sX && "" === this.s.dt.oScroll.sY || this.s.dt.oInstance.fnAdjustColumnSizing(!1), this.s.dt.oInstance.oApi._fnSaveState(this.s.dt), null !== this.s.reorderCallback && this.s.reorderCallback.call(this))
                ...
                _fnMouseDown: function (t, e) {
                    ...
                    r !== x && (this.s.mouse.startX = this._fnCursorPosition(t, "pageX"), this.s.mouse.startY = this._fnCursorPosition(t, "pageY"), this.s.mouse.offsetX = this._fnCursorPosition(t, "pageX") - o.left, this.s.mouse.offsetY = this._fnCursorPosition(t, "pageY") - o.top, this.s.mouse.target = this.s.dt.aoColumns[r].nTh, this.s.mouse.targetIndex = r, this.s.mouse.fromIndex = r, this._fnRegions(), w(a)
                ...
                _fnRegions: function () {
                    ...
                    this.s.aoTargets.splice(0, this.s.aoTargets.length), this.s.aoTargets.push({
                        x: w(this.s.dt.nTable)
                            .offset()
                            .left,
                        to: 0
                    });
                    for (var e = 0, n = this.s.aoTargets[0].x, o = 0, r = t.length; o < r; o++) o != this.s.mouse.fromIndex && e++, t[o].bVisible && "none" !== t[o].nTh.style.display && (n += w(t[o].nTh)
                        .outerWidth(), this.s.aoTargets.push({
                            x: n,
                            to: e
                        }));
                ...
                _fnCreateDragNode: function () {
                    ...
                    this.dom.drag = w(r.cloneNode(!1))
                        ...
                        .append(w(o.cloneNode(!1))
                            .append(w(n.cloneNode(!1))
                                .append(a[0])))
                        .css({
                            position: "absolute",
                            top: 0,
                        ...
                        .appendTo("body"), this.dom.pointer = w("<div></div>")
                        .addClass("DTCR_pointer")
                        .css({
                            position: "absolute",
                            top: t ? w("div.dataTables_scroll", this.s.dt.nTableWrapper)
                                .offset()
                                .top : w(this.s.dt.nTable)
                                .offset()
                                .top,
                            height: t ? w("div.dataTables_scroll", this.s.dt.nTableWrapper)
                                .height() : w(this.s.dt.nTable)
                                .height()
                        })
                        .appendTo("body")
                },
                ...
                cFeature: "R",
                sFeature: "ColReorder"
            }) : alert("Warning: ColReorder requires DataTables 1.10.8 or greater - www.datatables.net/download"), w(a)
            .on("preInit.dt.colReorder", function (t, e) {
                if ("dt" === t.namespace) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-colreorder"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.ColReorder || require("datatables.net-colreorder")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        ...
        var e, a = T.fn.dataTable,
            c = function (t, e) {
                ...
                if (this instanceof c) {
                    ...
                    var r = new T.fn.dataTable.Api(t)
                        .settings()[0];
                    if (this.s = {
                            dt: r,
        ...
        return T.extend(c.prototype, {
                ...
                fnGetPosition: function (t) {
                    ...
                    if (T(t)
                        .parents(".DTFC_Cloned")
                        .length) {
                        if ("tr" === t.nodeName.toLowerCase()) return e = T(t)
                            .index(), n.fnGetPosition(T("tr", this.s.dt.nTBody)[e]);
                        var o = T(t)
                            .index();
                        return e = T(t.parentNode)
                            .index(), [n.fnGetPosition(T("tr", this.s.dt.nTBody)[e]), o, n.oApi._fnVisibleToColumnIndex(this.s.dt, o)]
                    }
                ...
                _fnConstruct: function (t) {
                    ...
                    if ("function" == typeof this.s.dt.oInstance.fnVersionCheck && !0 === this.s.dt.oInstance.fnVersionCheck("1.8.0"))
                        if ("" !== this.s.dt.oScroll.sX) {
                            ...
                            this.dom.grid.dt = T(this.s.dt.nTable)
                                .parents("div." + n.sScrollWrapper)[0], this.dom.scroller = T("div." + n.sScrollBody, this.dom.grid.dt)[0], this._fnColCalc(), this._fnGridSetup();
                            var o = !1;
                            T(this.s.dt.nTableWrapper)
                                .on("mousedown.DTFC", function (t) {
                                    0 === t.button && (o = !0, T(d)
                            ...
                            0 < a.s.iLeftColumns && T(a.dom.grid.left.liner)
                                .on("mouseover.DTFC touchstart.DTFC", function () {
                                    o || (e = "left")
                                })
                                .on("scroll.DTFC", function (t) {
                                ...
                                }), 0 < a.s.iRightColumns && T(a.dom.grid.right.liner)
                                .on("mouseover.DTFC touchstart.DTFC", function () {
                                    o || (e = "right")
                                })
                                .on("scroll.DTFC", function (t) {
                            ...
                            s.on("draw.dt.DTFC", function () {
                                ...
                                .on("destroy.dt.DTFC", function () {
                                    s.off(".DTFC"), T(a.dom.scroller)
                                        .off(".DTFC"), T(l)
                                        .off(".DTFC"), T(a.s.dt.nTableWrapper)
                                        .off(".DTFC"), T(a.dom.grid.left.liner)
                                        .off(".DTFC " + r), T(a.dom.grid.left.wrapper)
                                        .remove(), T(a.dom.grid.right.liner)
                                        .off(".DTFC " + r), T(a.dom.grid.right.wrapper)
                                        .remove()
                ...
                _fnColCalc: function () {
                    ...
                    this.s.aiInnerWidths = [], this.s.aiOuterWidths = [], T.each(this.s.dt.aoColumns, function (t, e) {
                        ...
                        if (o.filter(":visible")
                            .length) {
                            var r = o.outerWidth();
                            0 === a.s.aiOuterWidths.length && (r += "string" == typeof (n = T(a.s.dt.nTable)
                                .css("border-left-width")) && -1 === n.indexOf("px") ? 1 : parseInt(n, 10)), a.s.aiOuterWidths.length === a.s.dt.aoColumns.length - 1 && (r += "string" == typeof (n = T(a.s.dt.nTable)
                                .css("border-right-width")) && -1 === n.indexOf("px") ? 1 : parseInt(n, 10)), a.s.aiOuterWidths.push(r), a.s.aiInnerWidths.push(o.width()), t < a.s.iLeftColumns && (i += r), a.s.iTableColumns - a.s.iRightColumns <= t && (s += r)
                ...
                _fnGridLayout: function () {
                    function t(t, e) {
                        i.bar ? n._firefoxScrollError() ? 34 < T(t)
                            .height() && (t.style.width = e + i.bar + "px") : t.style.width = e + i.bar + "px" : (t.style.width = e + 20 + "px", t.style.paddingRight = "20px", t.style.boxSizing = "border-box")
                    }
                    var e, n = this,
                        o = this.dom.grid,
                        r = (T(o.wrapper)
                            .width(), this.s.dt.nTable.parentNode.offsetHeight),
                        a = this.s.dt.nTable.parentNode.parentNode.offsetHeight,
                        i = this._fnDTOverflow(),
                        s = this.s.iLeftWidth,
                        l = this.s.iRightWidth,
                        d = "rtl" === T(this.dom.body)
                        .css("direction");
                    i.x && (r -= i.bar), o.wrapper.style.height = a + "px", 0 < this.s.iLeftColumns && ((e = o.left.wrapper)
                        .style.width = s + "px", e.style.height = "1px", d ? (e.style.left = "", e.style.right = 0) : (e.style.left = 0, e.style.right = ""), o.left.body.style.height = r + "px", o.left.foot && (o.left.foot.style.top = (i.x ? i.bar : 0) + "px"), t(o.left.liner, s), o.left.liner.style.height = r + "px", o.left.liner.style.maxHeight = r + "px"), 0 < this.s.iRightColumns && ((e = o.right.wrapper)
                        .style.width = l + "px", e.style.height = "1px", this.s.rtl ? (e.style.left = i.y ? i.bar + "px" : 0, e.style.right = "") : (e.style.left = "", e.style.right = i.y ? i.bar + "px" : 0), o.right.body.style.height = r + "px", o.right.foot && (o.right.foot.style.top = (i.x ? i.bar : 0) + "px"), t(o.right.liner, l), o.right.liner.style.height = r + "px", o.right.liner.style.maxHeight = r + "px", o.right.headBlock.style.display = i.y ? "block" : "none", o.right.footBlock.style.display = i.y ? "block" : "none")
                },
                ...
                _fnDraw: function (t) {
                    this._fnGridLayout(), this._fnCloneLeft(t), this._fnCloneRight(t), null !== this.s.fnDrawCallback && this.s.fnDrawCallback.call(this, this.dom.clone.left, this.dom.clone.right), T(this)
                        .trigger("draw.dtfc", {
                ...
                _fnClone: function (t, e, r, n) {
                    ...
                    if (n) {
                        for (T(t.header)
                            .remove(), t.header = T(this.dom.header)
                            .clone(!0, !1)[0], t.header.className += " DTFC_Cloned", t.header.style.width = "100%", e.head.appendChild(t.header), u = this._fnCopyLayout(m.aoHeader, r, !0), (f = T(">thead", t.header))
                            .empty(), o = 0, a = u.length; o < a; o++) f[0].appendChild(u[o].nTr);
                        ...
                        for (u = this._fnCopyLayout(m.aoHeader, r, !1), h = [], m.oApi._fnDetectHeader(h, T(">thead", t.header)[0]), o = 0, a = u.length; o < a; o++)
                            for (i = 0, s = u[o].length; i < s; i++) h[o][i].cell.className = u[o][i].cell.className, T("span.DataTables_sort_icon", h[o][i].cell)
                                .each(function () {
                                    this.className = T("span.DataTables_sort_icon", u[o][i].cell)[0].className
                                });
                    this._fnEqualiseHeights("thead", this.dom.header, t.header), "auto" == this.s.sHeightMatch && T(">tbody>tr", p.dom.body)
                        .css("height", "auto"), null !== t.body && (T(t.body)
                            .remove(), t.body = null), t.body = T(this.dom.body)
                        .clone(!0)[0], t.body.className += " DTFC_Cloned", t.body.style.paddingBottom = m.oScroll.iBarWidth + "px", t.body.style.marginBottom = 2 * m.oScroll.iBarWidth + "px", null !== t.body.getAttribute("id") && t.body.removeAttribute("id"), T(">thead>tr", t.body)
                        .empty(), T(">tfoot", t.body)
                        .remove();
                    var b = T("tbody", t.body)[0];
                    if (T(b)
                        .empty(), 0 < m.aiDisplay.length) {
                        var g = T(">thead>tr", t.body)[0];
                        for (c = 0; c < r.length; c++) {
                            l = r[c], (d = T(m.aoColumns[l].nTh)
                                    .clone(!0)[0])
                                .innerHTML = "";
                            var v = d.style;
                        ...
                        T(">tbody>tr", p.dom.body)
                            .each(function (t) {
                                var e = !1 === p.s.dt.oFeatures.bServerSide ? p.s.dt.aiDisplay[p.s.dt._iDisplayStart + t] : t,
                                    n = p.s.dt.aoData[e].anCells || T(this)
                                    .children("td, th"),
                                    o = this.cloneNode(!1);
                                for (o.removeAttribute("id"), o.setAttribute("data-dt-row", e), c = 0; c < r.length; c++) l = r[c], 0 < n.length && ((d = T(n[l])
                                        .clone(!0, !0)[0])
                                    .removeAttribute("id"), d.setAttribute("data-dt-row", e), d.setAttribute("data-dt-column", l), o.appendChild(d));
                                b.appendChild(o)
                            })
                    } else T(">tbody>tr", p.dom.body)
                        .each(function (t) {
                            (d = this.cloneNode(!0))
                            .className += " DTFC_NoData", T("td", d)
                                .html(""), b.appendChild(d)
                        });
                    ...
                    if (e.liner.appendChild(t.body), this._fnEqualiseHeights("tbody", p.dom.body, t.body), null !== m.nTFoot) {
                        if (n) {
                            null !== t.footer && t.footer.parentNode.removeChild(t.footer), t.footer = T(this.dom.footer)
                                .clone(!0, !0)[0], t.footer.className += " DTFC_Cloned", t.footer.style.width = "100%", e.foot.appendChild(t.footer), u = this._fnCopyLayout(m.aoFooter, r, !0);
                    ...
                    T(_)
                        ...
                        }), null !== p.s.dt.nTFoot && (_ = m.oApi._fnGetUniqueThs(m, T(">tfoot", t.footer)[0]), T(_)
                            .each(function (t) {
                                l = r[t], this.style.width = p.s.aiInnerWidths[l] + "px"
                            }))
                },
                ...
                _firefoxScrollError: function () {
                    if (e === C) {
                        var t = T("<div/>")
                            ...
                            .appendTo("body");
                        e = t[0].clientWidth === t[0].offsetWidth && 0 !== this._fnDTOverflow()
                            .bar, t.remove()
                    }
                    return e
                }
                ...
                return this.iterator("row", function (t, e) {
                    t._oFixedColumns && t._oFixedColumns.fnRecalculateHeight(this.row(e)
                        .node())
                })
                ...
                if ((t = T(t))
                    ...
                    var e, n = t.parent()
                        ...
                        .indexes()[n];
                    if (t.parents(".DTFC_LeftWrapper")
                        .length) e = t.index();
                    else e = this.columns()
                        .flatten()
                        .length - this.context[0]._oFixedColumns.s.iRightColumns + t.index();
                    return {
                        row: o,
            ...
            .on("init.dt.fixedColumns", function (t, e) {
                if ("dt" === t.namespace) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-fixedcolumns"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.FixedColumns || require("datatables.net-fixedcolumns")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        return t.fn.dataTable
    }),
        ...
        return s.extend(d.prototype, {
                ...
                _constructor: function () {
                    ...
                    !this.c.footerOffset && o.length && (this.c.footerOffset = o.outerHeight()), e.on("column-reorder.dt.dtfc column-visibility.dt.dtfc draw.dt.dtfc column-sizing.dt.dtfc responsive-display.dt.dtfc", function () {
                        ...
                        t.c.header && t._modeChange("in-place", "header", !0), t.c.footer && t.dom.tfoot.length && t._modeChange("in-place", "footer", !0), e.off(".dtfc"), s(r)
                            .off(t.s.namespace)
                ...
                _clone: function (t, e) {
                    ...
                    !e && o.floating ? o.floating.removeClass("fixedHeader-floating fixedHeader-locked") : (o.floating && (o.placeholder.remove(), this._unsize(t), o.floating.children()
                            .detach(), o.floating.remove()), o.floating = s(n.table()
                            .node()
                            .cloneNode(!1))
                        ...
                        .removeAttr("id")
                        .append(r)
                        .appendTo("body"), o.placeholder = r.clone(!1), o.placeholder.find("*[id]")
                        .removeAttr("id"), o.host.prepend(o.placeholder), this._matchWidths(o.placeholder, o.floating))
                },
                ...
                _unsize: function (t) {
                    ...
                    e && ("footer" === t || "header" === t && !this.s.autoWidth) ? s("th, td", e)
                        .css({
                            width: "",
                            minWidth: ""
                        }) : e && "header" === t && s("th, td", e)
                        .css("min-width", "")
                },
                ...
                _modeChange: function (t, e, n) {
                    ...
                    i && i.blur(), "in-place" === t ? (o.placeholder && (o.placeholder.remove(), o.placeholder = null), this._unsize(e), "header" === e ? o.host.prepend(a) : o.host.append(a), o.floating && (o.floating.remove(), o.floating = null)) : "in" === t ? (this._clone(e, n), o.floating.addClass("fixedHeader-floating")
                        .css("header" === e ? "top" : "bottom", this.c[e + "Offset"])
                        .css("left", r.left + "px")
                        .css("width", r.width + "px"), "footer" === e && o.floating.css("top", "")) : "below" === t ? (this._clone(e, n), o.floating.addClass("fixedHeader-locked")
                        .css("top", r.tfootTop - r.theadHeight)
                        .css("left", r.left + "px")
                        .css("width", r.width + "px")) : "above" === t && (this._clone(e, n), o.floating.addClass("fixedHeader-locked")
                        .css("top", r.tbodyTop)
                        .css("left", r.left + "px")
                        .css("width", r.width + "px")), i && i !== l.activeElement && setTimeout(function () {
                        i.focus()
                ...
                _positions: function () {
                    var t = this.s.dt.table(),
                        ...
                        a = o.children("tfoot"),
                        i = n.tbody;
                    e.visible = o.is(":visible"), e.width = o.outerWidth(), e.left = o.offset()
                        .left, e.theadTop = r.offset()
                        .top, e.tbodyTop = i.offset()
                        .top, e.theadHeight = e.tbodyTop - e.theadTop, a.length ? (e.tfootTop = a.offset()
                            .top, e.tfootBottom = e.tfootTop + a.outerHeight(), e.tfootHeight = e.tfootBottom - e.tfootTop) : (e.tfootTop = e.tbodyTop + i.outerHeight(), e.tfootBottom = e.tfootTop, e.tfootHeight = e.tfootTop)
                },
                _scroll: function (t) {
                    var e, n, o = s(l)
                        .scrollTop(),
                ...
                headerOffset: 0,
                footerOffset: 0
            }, s.fn.dataTable.FixedHeader = d, s.fn.DataTable.FixedHeader = d, s(l)
            .on("init.dt.dtfh", function (t, e, n) {
                if ("dt" === t.namespace) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-fixedheader"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.FixedHeader || require("datatables.net-fixedheader")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        return t.fn.dataTable
    }),
        ...
        return p.extend(s.prototype, {
                ...
                _constructor: function () {
                    ...
                    var a = this,
                        ...
                        t = p(i.table()
                            .node());
                    if ("static" === t.css("position") && t.css("position", "relative"), p(i.table()
                            .body())
                        .on("click.keyTable", "th, td", function (t) {
                            if (!1 !== a.s.enable) {
                                var e = i.cell(this);
                                e.any() && a._focus(e, null, !1, t)
                            }
                        }), p(b)
                        .on("keydown.keyTable", function (t) {
                            a._key(t)
                        }), this.c.blurable && p(b)
                        .on("mousedown.keyTable", function (t) {
                            p(t.target)
                                .parents(".dataTables_filter")
                                .length && a._blur(), p(t.target)
                                .parents()
                                .filter(i.table()
                                    .container())
                                .length || p(t.target)
                        ...
                        o.on("open.keyTableMain", function (t, e, n) {
                                ...
                                .body())
                            .on("dblclick.keyTable", "th, td", function (t) {
                                !1 !== a.s.enable && i.cell(this)
                                    .any() && a._editor(null, t, !0)
                            })
                    }
                    i.settings()[0].oFeatures.bStateSave && i.on("stateSaveParams.keyTable", function (t, e, n) {
                        ...
                        i.off(".keyTable"), p(i.table()
                                .body())
                            .off("click.keyTable", "th, td"), p(b)
                    ...
                    e && e.keyTable ? i.one("init", function () {
                            ...
                            t.any() && t.focus()
                        }) : this.c.focus && i.cell(this.c.focus)
                        .focus()
                },
                _blur: function () {
                    if (this.s.enable && this.s.lastFocus) {
                        ...
                        p(t.node())
                            .removeClass(this.c.className), this.s.lastFocus = null, this._updateFixedColumns(t.index()
                                .column), this._emitEvent("key-blur", [this.s.dt, t])
                    }
                },
                _clipboard: function () {
                    var i = this.s.dt,
                    ...
                    m.getSelection && (p(b)
                        ...
                        .on("paste.keyTable", function (t) {
                            var e, n = t.originalEvent,
                                o = s.s.lastFocus,
                                r = b.activeElement,
                                a = s.c.editor;
                            !o || r && "body" !== r.nodeName.toLowerCase() || (n.preventDefault(), m.clipboardData && m.clipboardData.getData ? e = m.clipboardData.getData("Text") : n.clipboardData && n.clipboardData.getData && (e = n.clipboardData.getData("text/plain")), a ? a.inline(o.cell.index())
                                .set(a.displayed()[0], e)
                                .submit() : (o.cell.data(e), i.draw(!1)))
                        }))
                },
                _columns: function () {
                    var t = this.s.dt,
                        e = t.columns(this.c.columns)
                        .indexes(),
                        n = [];
                    return t.columns(":visible")
                        .every(function (t) {
                ...
                _editor: function (t, e, n) {
                    ...
                    if (!(p("div.DTE", i.node())
                            .length || null !== t && (0 <= t && t <= 9 || 11 === t || 12 === t || 14 <= t && t <= 31 || 112 <= t && t <= 123 || 127 <= t && t <= 159))) {
                        e.stopPropagation(), 13 === t && e.preventDefault();
                        var s = function () {
                            a.one("open.keyTable", function () {
                                    a.off("cancelOpen.keyTable"), n || p("div.DTE_Field_InputControl input, div.DTE_Field_InputControl textarea")
                                        .select(), r.keys.enable(n ? "tab-only" : "navigation-only"), r.on("key-blur.editor", function () {
                                            a.displayed() && a.submit()
                                        }), n && p(r.table()
                                            .container())
                                        .addClass("dtk-focus-alt"), a.on("submitUnsuccessful.keyTable", function () {
                                            o._focus(i, null, !1)
                                        }), a.one("close", function () {
                                            r.keys.enable(!0), r.off("key-blur.editor"), a.off(".keyTable"), p(r.table()
                                                    .container())
                        ...
                        if (e)
                            if (!(0 === t.keyCode || t.ctrlKey || t.metaKey || t.altKey) || t.ctrlKey && t.altKey)
                                if (this.s.lastFocus) {
                                    ...
                                    case 33:
                                    case 34:
                                        n && !r && (t.preventDefault(), o.page(33 === t.keyCode ? "previous" : "next")
                                            .draw(!1));
                                        break;
                                    case 35:
                                    case 36:
                ...
                _scroll: function (t, e, n, o) {
                    var r = n[o](),
                        ...
                        d = t.height(),
                        c = t.width();
                    "position" === o && (r.top += parseInt(n.closest("table")
                        .css("top"), 10)), r.top < s && e.scrollTop(r.top), r.left < l && e.scrollLeft(r.left), r.top + a > s + d && a < d && e.scrollTop(r.top + a - d), r.left + i > l + c && i < c && e.scrollLeft(r.left + i - c)
                },
                ...
                _tabInput: function () {
                    var e = this,
                        n = this.s.dt,
                        t = null !== this.c.tabIndex ? this.c.tabIndex : n.settings()[0].iTabIndex; - 1 != t && p('<div><input type="text" tabindex="' + t + '"/></div>')
                        .css({
                            position: "absolute",
                            height: 1,
                            width: 0,
            ...
            .on("preInit.dt.dtk", function (t, e, n) {
                if ("dt" === t.namespace) {
                    var o = e.oInit.keys,
                        r = i.defaults.keys;
                    if (o || r) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-keytable"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.KeyTable || require("datatables.net-keytable")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        return t.fn.dataTable
    }),
    function (n) {
            ...
            r = function (t, e) {
                ...
                this.s = {
                    ...
                    current: []
                        ...
                        type: "inline"
                    }), this.c = p.extend(!0, {}, r.defaults, a.defaults.responsive, e), (t.responsive = this)
                    ._constructor())
            };
        p.extend(r.prototype, {
            _constructor: function () {
                var o = this,
                    ...
                    e = p(h)
                    .width();
                r.settings()[0]._responsive = this, p(h)
                    .on("resize.dtr orientationchange.dtr", a.util.throttle(function () {
                        var t = p(h)
                            .width();
                        t !== e && (o._resize(), e = t)
                    })), t.oApi._fnCallbackReg(t, "aoRowCreatedCallback", function (t, e, n) {
                        -1 !== p.inArray(!1, o.s.current) && p(">td, >th", t)
                            .each(function (t) {
                                var e = r.column.index("toData", t);
                                !1 === o.s.current[e] && p(this)
                                    .css("display", "none")
                            })
                        ...
                        r.off(".dtr"), p(r.table()
                                .body())
                            .off(".dtr"), p(h)
                            .off("resize.dtr orientationchange.dtr"), p.each(o.s.current, function (t, e) {
                ...
                !1 !== n.type && (o._detailsInit(), r.on("column-visibility.dtr", function () {
                        ...
                        .node())
                    .addClass("dtr-" + n.type)), r.on("column-reorder.dtr", function (t, e, n) {
                    ...
                    r.rows()
                        .every(function () {
                            ...
                            o._resizeAuto(), o._resize(), r.rows(t)
                                .every(function () {
            ...
            _columnsVisiblity: function (n) {
                var t, e, o = this.s.dt,
                    ...
                    i = p.map(r, function (t, e) {
                        return !1 === o.column(e)
                            .visible() ? "not-visible" : (!t.auto || null !== t.minWidth) && (!0 === t.auto ? "-" : -1 !== p.inArray(n, t.includeIn))
                    }),
                    s = 0;
            ...
            _classLogic: function () {
                ...
                function l(t, e, n, o) {
                    ...
                    if (n) {
                        if ("max-" === n)
                            for (r = d._find(e)
                                .width, a = 0, i = c.length; a < i; a++) c[a].width <= r && s(t, c[a].name);
                        else if ("min-" === n)
                            for (r = d._find(e)
                                .width, a = 0, i = c.length; a < i; a++) c[a].width >= r && s(t, c[a].name);
                        else if ("not-" === n)
            ...
            _detailsDisplay: function (t, e) {
                ...
                if (r && !1 !== r.type) {
                    ...
                    !0 !== a && !1 !== a || p(o.table()
                            .node())
                        .triggerHandler("responsive-display.dt", [o, t, a, e])
                }
            },
            _detailsInit: function () {
                ...
                "inline" === t.type && (t.target = "td:first-child, th:first-child"), r.on("draw.dtr", function () {
                        o._tabIndexes()
                    }), o._tabIndexes(), p(r.table()
                        .body())
                    .on("keyup.dtr", "td, th", function (t) {
                        13 === t.keyCode && p(this)
                            .data("dtr-keyboard") && p(this)
                            .click()
                    });
                var a = t.target,
                ...
                p(r.table()
                        .body())
                    .on("click.dtr mousedown.dtr mouseup.dtr", e, function (t) {
                        if (p(r.table()
                                .node())
                            .hasClass("collapsed") && -1 !== p.inArray(p(this)
                                .closest("tr")
                                .get(0), r.rows()
                                .nodes()
                                .toArray())) {
                            ...
                            var n = r.row(p(this)
                                .closest("tr"));
                            "click" === t.type ? o._detailsDisplay(n, !1) : "mousedown" === t.type ? p(this)
                                .css("outline", "none") : "mouseup" === t.type && p(this)
                                .blur()
                                .css("outline", "")
                        }
                    })
            ...
            _detailsObj: function (n) {
                ...
                return p.map(this.s.columns, function (t, e) {
                    if (!t.never && !t.control) return {
                        ...
                        data: r.cell(n, e)
                            .render(o.c.orthogonal),
                        hidden: r.column(e)
                            .visible() && !o.s.current[e],
                        columnIndex: e,
                        rowIndex: n
                    }
                })
            ...
            _resize: function () {
                ...
                for (t = 0, e = s.length; t < e; t++)
                    if (!1 === d[t] && !s[t].never && !s[t].control && !1 == !o.column(t)
                        .visible()) {
                        c = !0;
                        break
                    } p(o.table()
                ...
                o.columns()
                    ...
                    }), u && (this._redrawChildren(), p(o.table()
                            .node())
                        .trigger("responsive-resize.dt", [o, this.s.current]), 0 === o.page.info()
                        .recordsDisplay && p("td", o.table()
                            .body())
                        .eq(0)
                        .attr("colspan", f))
            },
            _resizeAuto: function () {
                ...
                if (this.c.auto && -1 !== p.inArray(!0, p.map(o, function (t) {
                    ...
                    p("<tr/>")
                        .append(a)
                        .appendTo(e), "inline" === this.c.details.type && p(t)
                        .addClass("dtr-inline collapsed"), p(t)
                        .find("[name]")
                        .removeAttr("name"), p(t)
                    ...
                    var d = p("<div/>")
                        ...
                        .append(t);
                    d.insertBefore(n.table()
                        .node()), a.each(function (t) {
            ...
            _setColumnVis: function (t, e) {
                ...
                p(n.column(t)
                        .header())
                    .css("display", o), p(n.column(t)
                        .footer())
                    .css("display", o), n.column(t)
                    .nodes()
                    .to$()
                    .css("display", o), p.isEmptyObject(u) || n.cells(null, t)
                    .indexes()
                    .each(function (t) {
                        c(n, t.row, t.column)
                    })
            ...
            _tabIndexes: function () {
                ...
                e.filter("[data-dtr-keyboard]")
                    .removeData("[data-dtr-keyboard]"), "number" == typeof o ? t.cells(null, o, {
                        page: "current"
                    })
                    .nodes()
                    .to$()
                    .attr("tabIndex", n.iTabIndex)
                    .data("dtr-keyboard", 1) : ("td:first-child, th:first-child" === o && (o = ">td:first-child, >th:first-child"), p(o, t.rows({
                                page: "current"
                            })
                            .nodes())
                        .attr("tabIndex", n.iTabIndex)
            ...
            childRow: function (t, e, n) {
                return e ? p(t.node())
                    .hasClass("parent") ? (t.child(n(), "child")
                        .show(), !0) : void 0 : t.child.isShown() ? (t.child(!1), p(t.node())
                        .removeClass("parent"), !1) : (t.child(n(), "child")
                        .show(), p(t.node())
                        .addClass("parent"), !0)
            },
            childRowImmediate: function (t, e, n) {
                return !e && t.child.isShown() || !t.responsive.hasHidden() ? (t.child(!1), p(t.node())
                    .removeClass("parent"), !1) : (t.child(n(), "child")
                    .show(), p(t.node())
                    .addClass("parent"), !0)
            },
                ...
                return function (t, e, n) {
                    if (e) p("div.dtr-modal-content")
                        ...
                        var o = function () {
                            ...
                            r = p('<div class="dtr-modal"/>')
                            .append(p('<div class="dtr-modal-display"/>')
                                .append(p('<div class="dtr-modal-content"/>')
                                    .append(n()))
                                .append(p('<div class="dtr-modal-close">&times;</div>')
                                    .click(function () {
                                        o()
                                    })))
                            .append(p('<div class="dtr-modal-background"/>')
                                .click(function () {
                                    o()
                                }))
                            .appendTo("body");
                        p(i)
                            .on("keyup.dtr", function (t) {
                                27 === t.keyCode && (t.stopPropagation(), o())
                            })
                    }
                    a && a.header && p("div.dtr-modal-content")
                        .prepend("<h2>" + a.header(t) + "</h2>")
                }
            }
        };
        var u = {};
        ...
        function c(t, e, n) {
            var o = e + "-" + n;
            if (u[o]) {
                for (var r = t.cell(e, n)
                        .node(), a = u[o][0].parentNode.childNodes, i = [], s = 0, l = a.length; s < l; s++) i.push(a[s]);
            ...
            listHiddenNodes: function () {
                return function (n, t, e) {
                    ...
                    p.each(e, function (t, e) {
                        e.hidden && (p('<li data-dtr-index="' + e.columnIndex + '" data-dt-row="' + e.rowIndex + '" data-dt-column="' + e.columnIndex + '"><span class="dtr-title">' + e.title + "</span> </li>")
                            .append(p('<span class="dtr-data"/>')
                                .append(function (t, e, n) {
                                    var o = e + "-" + n;
                                    if (u[o]) return u[o];
                                    for (var r = [], a = t.cell(e, n)
                                            .node()
                                            .childNodes, i = 0, s = a.length; i < s; i++) r.push(a[i]);
                                    return u[o] = r
            ...
            listHidden: function () {
                return function (t, e, n) {
                    var o = p.map(n, function (t) {
                        ...
                        .join("");
                    return !!o && p('<ul data-dtr-index="' + e + '" class="dtr-details"/>')
                        .append(o)
                }
            },
            tableAll: function (r) {
                return r = p.extend({
                    ...
                    function (t, e, n) {
                        var o = p.map(n, function (t) {
                            ...
                            .join("");
                        return p('<table class="' + r.tableClass + ' dtr-details" width="100%"/>')
                            .append(o)
                    }
            }
        }, r.defaults = {
        ...
        return t.register("responsive()", function () {
            ...
            }), r.version = "2.2.3", p.fn.dataTable.Responsive = r, p.fn.DataTable.Responsive = r, p(i)
            .on("preInit.dt.dtr", function (t, e, n) {
                if ("dt" === t.namespace && (p(e.nTable)
                        .hasClass("responsive") || p(e.nTable)
                        .hasClass("dt-responsive") || e.oInit.responsive || a.defaults.responsive)) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-responsive"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.Responsive || require("datatables.net-responsive")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (i, t, e, n) {
        "use strict";
                    ...
                    if (!e) {
                        if (a && a.header) {
                            var o = l.find("div.modal-header"),
                                ...
                                .detach();
                            o.empty()
                                .append('<h4 class="modal-title">' + a.header(t) + "</h4>")
                                .append(r)
                        }
                        l.find("div.modal-body")
                            .empty()
                            .append(n()), l.appendTo("body")
                            .modal()
                    }
                } else s(t, e, n)
            }
    ...
    function (n) {
        ...
        return u.extend(i.prototype, {
                dataSrc: function (t) {
                    ...
                    var e = this.s.dt;
                    return this.c.dataSrc = t, u(e.table()
                            .node())
                        .triggerHandler("rowgroup-datasrc.dt", [e, t]), this
                },
                disable: function () {
                ...
                _adjustColspan: function () {
                    u("tr." + this.c.className, this.s.dt.table()
                            .body())
                        .find("td")
                ...
                _group: function (t, e) {
                    for (var n, o = u.isArray(this.c.dataSrc) ? this.c.dataSrc : [this.c.dataSrc], r = h.ext.oApi._fnGetObjectDataFn(o[t]), a = this.s.dt, i = [], s = 0, l = e.length; s < l; s++) {
                        var d, c = e[s];
                        null !== (d = r(a.row(c)
                            .data())) && d !== f || (d = that.c.emptyDataGroup), n !== f && d === n || (i.push({
                            dataPoint: d,
                            rows: []
                ...
                _groupDisplay: function (t, e) {
                    for (var n, o = this.s.dt, r = 0, a = e.length; r < a; r++) {
                        var i, s = e[r],
                            l = s.dataPoint,
                            d = s.rows;
                        this.c.startRender && (n = this.c.startRender.call(this, o.rows(d), l, t), (i = this._rowWrap(n, this.c.startClassName, t)) && i.insertBefore(o.row(d[0])
                            .node())), this.c.endRender && (n = this.c.endRender.call(this, o.rows(d), l, t), (i = this._rowWrap(n, this.c.endClassName, t)) && i.insertAfter(o.row(d[d.length - 1])
                            .node())), s.children && this._groupDisplay(t + 1, s.children)
                    }
                },
                _rowWrap: function (t, e, n) {
                    return null !== t && "" !== t || (t = this.c.emptyDataGroup), t === f ? null : ("object" == typeof t && t.nodeName && "tr" === t.nodeName.toLowerCase() ? u(t) : t instanceof u && t.length && "tr" === t[0].nodeName.toLowerCase() ? t : u("<tr/>")
                            .append(u("<td/>")
                                .attr("colspan", this._colspan())
                                .append(t)))
            ...
            .on("preInit.dt.dtrg", function (t, e, n) {
                if ("dt" === t.namespace) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-rowgroup"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.RowGroup || require("datatables.net-rowgroup")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        return t.fn.dataTable
    }),
    function (n) {
        ...
        var i = v.fn.dataTable,
            l = function (t, e) {
                ...
                this.c = v.extend(!0, {}, i.defaults.rowReorder, l.defaults, e), this.s = {
                    ...
                    clone: null,
                    dtScroll: v("div.dataTables_scrollBody", this.s.dt.table()
                        .container())
                };
                var n = this.s.dt.settings()[0],
                    o = n.rowreorder;
        ...
        v.extend(l.prototype, {
            _constructor: function () {
                var o = this,
                    ...
                    t = v(r.table()
                        .node());
                "static" === t.css("position") && t.css("position", "relative"), v(r.table()
                        .container())
                    .on("mousedown.rowReorder touchstart.rowReorder", this.c.selector, function (t) {
                        if (o.c.enable) {
                            if (v(t.target)
                                .is(o.c.excludedChildren)) return !0;
                            var e = v(this)
                                .closest("tr"),
                                n = r.row(e);
                        ...
                        v(r.table()
                                .container())
                            .off(".rowReorder"), r.off(".rowReorder")
                    })
            },
            _cachePositions: function () {
                var n = this.s.dt,
                    ...
                    e = v.map(r, function (t, e) {
                        return r.length < e - 1 ? (t + r[e + 1]) / 2 : (t + t + v(n.row(":last-child")
                                .node())
                            .outerHeight()) / 2
                    });
                this.s.middles = e, this.s.bodyTop = v(n.table()
                        .body())
                    .offset()
                    .top, this.s.windowHeight = v(s)
                    .height(), this.s.documentOuterHeight = v(y)
                    .outerHeight()
            },
            _clone: function (t) {
                var e = this.s.dt,
            ...
            _mouseDown: function (t, e) {
                ...
                r.top = this._eventToPage(t, "Y"), r.left = this._eventToPage(t, "X"), r.offsetTop = a.top, r.offsetLeft = a.left, r.nodes = v.unique(o.rows({
                        ...
                        .nodes()
                        .toArray()), this._cachePositions(), this._clone(e), this._clonePosition(t), (this.dom.target = e)
                    .addClass("dt-rowReorder-moving"), v(y)
                ...
                this.s.scroll = {
                    ...
                    windowWidth: v(s)
                        .width(),
                    dtTop: i.length ? i.offset()
                        .top : null,
                    dtLeft: i.length ? i.offset()
                        .left : null,
            ...
            _mouseMove: function (t) {
                ...
                for (var e = this._eventToPage(t, "Y") - this.s.bodyTop, n = this.s.middles, o = null, r = this.s.dt, a = r.table()
                        .body(), i = 0, s = n.length; i < s; i++)
                    if (e < n[i]) {
                        o = i;
                        break
            ...
            _mouseUp: function (t) {
                var e, n, o = this,
                    r = this.s.dt,
                    a = this.c.dataSrc;
                this.dom.clone.remove(), this.dom.clone = null, this.dom.target.removeClass("dt-rowReorder-moving"), v(y)
                    .off(".rowReorder"), v(y.body)
                    .removeClass("dt-rowReorder-noOverflow"), clearInterval(this.s.scrollInterval), this.s.scrollInterval = null;
                ...
                function g() {
                    if (o.c.update) {
                        for (e = 0, n = d.length; e < n; e++) {
                            var t = r.row(d[e].node)
                                .data();
                            f(t, d[e].newData), r.columns()
                                .every(function () {
                                    this.dataSrc() === a && r.cell(d[e].node, this.index())
                                        .invalidate("data")
                                })
                        }
        ...
        return e.register("rowReorder()", function () {
            ...
            }), l.version = "1.2.5", v.fn.dataTable.RowReorder = l, v.fn.DataTable.RowReorder = l, v(y)
            .on("init.dt.dtr", function (t, e, n) {
                if ("dt" === t.namespace) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-rowreorder"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.RowReorder || require("datatables.net-rowreorder")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        return t.fn.dataTable
    }),
    function (n) {
        ...
        g.extend(l.prototype, {
                measure: function (t) {
                    ...
                    e.row && (e.viewport = g.contains(o, this.dom.scroller) ? this.dom.scroller.clientHeight : this._parseHeight(g(this.dom.scroller)
                        .css("height")), e.viewport || (e.viewport = this._parseHeight(g(this.dom.scroller)
                        .css("max-height"))), this.s.viewportRows = parseInt(e.viewport / e.row, 10) + 1, this.s.dt._iDisplayLength = this.s.viewportRows * this.s.displayBuffer);
                ...
                scrollToRow: function (t, e) {
                    ...
                    a < 0 && (a = 0), (r > this.s.redrawBottom || r < this.s.redrawTop) && this.s.dt._iDisplayStart !== a && (o = !0, r = this._domain("virtualToPhysical", t * this.s.heights.row), this.s.redrawTop < r && r < this.s.redrawBottom && (e = !(this.s.forceReposition = !0))), void 0 === e || e ? (this.s.ani = o, g(this.dom.scroller)
                            .animate({
                                scrollTop: r
                            }, function () {
                                setTimeout(function () {
                ...
                construct: function () {
                    ...
                    if (this.s.dt.oFeatures.bPaginate) {
                        this.dom.force.style.position = "relative", this.dom.force.style.top = "0px", this.dom.force.style.left = "0px", this.dom.force.style.width = "1px", this.dom.scroller = g("div." + this.s.dt.oClasses.sScrollBody, this.s.dt.nTableWrapper)[0], this.dom.scroller.appendChild(this.dom.force), this.dom.scroller.style.position = "relative", this.dom.table = g(">table", this.dom.scroller)[0], this.dom.table.style.position = "absolute", this.dom.table.style.top = "0px", this.dom.table.style.left = "0px", g(t.table()
                                .container())
                            .addClass("dts DTS"), this.s.loadingIndicator && (this.dom.loader = g('<div class="dataTables_processing dts_loading">' + this.s.dt.oLanguage.sLoadingRecords + "</div>")
                                .css("display", "none"), g(this.dom.scroller.parentNode)
                                .css("position", "relative")
                                .append(this.dom.loader)), this.dom.label.appendTo(this.dom.scroller), this.s.heights.row && "auto" != this.s.heights.row && (this.s.autoHeight = !1), this.measure(!1), this.s.ingnoreScroll = !0, this.s.stateSaveThrottle = this.s.dt.oApi._fnThrottle(function () {
                                o.s.dtApi.state.save()
                            }, 500), g(this.dom.scroller)
                            .on("scroll.dt-scroller", function (t) {
                                o._scroll.call(o)
                            }), g(this.dom.scroller)
                        ...
                        t.on("stateSaveParams.scroller", function (t, e, n) {
                            ...
                            g(i)
                                .off("resize.dt-scroller"), g(o.dom.scroller)
                                .off(".dt-scroller"), g(o.s.dt.nTable)
                                .off(".scroller"), g(o.s.dt.nTableWrapper)
                                .removeClass("DTS"), g("div.DTS_Loading", o.dom.scroller.parentNode)
                                .remove(), o.dom.table.style.position = "", o.dom.table.style.top = "", o.dom.table.style.left = ""
                        })
                ...
                _calcRowHeight: function () {
                    ...
                    g("div." + t.oClasses.sScrollBody, r)
                        .append(n);
                    var i = this.s.dt.nHolding || e.parentNode;
                    g(i)
                        .is(":visible") || (i = "body"), r.appendTo(i), this.s.heights.row = g("tr", o)
                        .eq(1)
                        .outerHeight(), r.remove()
                },
                _draw: function () {
                    var t = this,
                        e = this.s.heights,
                        n = this.dom.scroller.scrollTop,
                        o = (e.viewport, g(this.s.dt.nTable)
                            .height()),
                        r = this.s.dt._iDisplayStart,
                        a = this.s.dt._iDisplayLength,
                        i = this.s.dt.fnRecordsDisplay();
                    this.s.skip = !0, !this.s.dt.bSorted && !this.s.dt.bFiltered || 0 !== r || this.s.dt._drawHold || (this.s.topRowFloat = 0), n = "jump" === this.scrollType ? this._domain("physicalToVirtual", this.s.topRowFloat * e.row) : n, g(t.dom.scroller)
                        .scrollTop(n), this.s.baseScrollTop = n, this.s.baseRowTop = this.s.topRowFloat;
                    ...
                    if (this.s.redrawTop = n - l, this.s.redrawBottom = n + l > e.scroll - e.viewport - e.row ? e.scroll - e.viewport - e.row : n + l, this.s.skip = !1, this.s.dt.oFeatures.bStateSave && null !== this.s.dt.oLoadedState && void 0 !== this.s.dt.oLoadedState.iScroller) {
                        ...
                        (d && 2 == this.s.dt.iDraw || !d && 1 == this.s.dt.iDraw) && setTimeout(function () {
                            g(t.dom.scroller)
                                .scrollTop(t.s.dt.oLoadedState.iScroller), t.s.redrawTop = t.s.dt.oLoadedState.iScroller - e.viewport / 2, setTimeout(function () {
                                    t.s.ingnoreScroll = !1
                                }, 0)
                        }, 0)
                ...
                _info: function () {
                    if (this.s.dt.oFeatures.bInfo) {
                        ...
                        t = 0 === e.fnRecordsDisplay() && e.fnRecordsDisplay() == e.fnRecordsTotal() ? n.sInfoEmpty + n.sInfoPostFix : 0 === e.fnRecordsDisplay() ? n.sInfoEmpty + " " + n.sInfoFiltered.replace("_MAX_", u) + n.sInfoPostFix : e.fnRecordsDisplay() == e.fnRecordsTotal() ? n.sInfo.replace("_START_", d)
                            .replace("_END_", c)
                            .replace("_MAX_", u)
                            .replace("_TOTAL_", f) + n.sInfoPostFix : n.sInfo.replace("_START_", d)
                            .replace("_END_", c)
                            .replace("_MAX_", u)
                            .replace("_TOTAL_", f) + " " + n.sInfoFiltered.replace("_MAX_", e.fnFormatNumber(e.fnRecordsTotal())) + n.sInfoPostFix;
                        var h = n.fnInfoCallback;
                        h && (t = h.call(e.oInstance, e, r, l, a, i, t));
                        var p = e.aanFeatures.i;
                        if (void 0 !== p)
                            for (var m = 0, b = p.length; m < b; m++) g(p[m])
                                .html(t);
                        g(e.nTable)
                ...
                _parseHeight: function (t) {
                    ...
                    var o = parseFloat(n[1]),
                        r = n[2];
                    return "px" === r ? e = o : "vh" === r ? e = o / 100 * g(i)
                        .height() : "rem" === r ? e = o * parseFloat(g(":root")
                            .css("font-size")) : "em" === r && (e = o * parseFloat(g("body")
                            .css("font-size"))), e || 0
                },
                _scroll: function () {
                    var t, e = this,
                        ...
                        if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
                            ...
                            if (this._info(), clearTimeout(this.s.stateTO), this.s.stateTO = setTimeout(function () {
                                ...
                                if (t = parseInt(this.s.topRowFloat, 10) - r, this.s.forceReposition = !1, t <= 0 ? t = 0 : t + this.s.dt._iDisplayLength > this.s.dt.fnRecordsDisplay() ? (t = this.s.dt.fnRecordsDisplay() - this.s.dt._iDisplayLength) < 0 && (t = 0) : t % 2 != 0 && t++, t != this.s.dt._iDisplayStart) {
                                    this.s.tableTop = g(this.s.dt.nTable)
                                        .offset()
                                        .top, this.s.tableBottom = g(this.s.dt.nTable)
                            ...
                            this.s.lastScrollTop = o, this.s.stateSaveThrottle(), "jump" === this.s.scrollType && this.s.mousedown && this.dom.label.html(this.s.dt.fnFormatNumber(parseInt(this.s.topRowFloat, 10) + 1))
                                .css("top", o + o * n.labelFactor)
                                .css("display", "block")
                        }
                },
                ...
                rowHeight: "auto",
                serverWait: 200
            }, l.oDefaults = l.defaults, l.version = "2.0.0", g(o)
            .on("preInit.dt.dtscroller", function (t, e) {
                if ("dt" === t.namespace) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-scroller"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.Scroller || require("datatables.net-scroller")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        return t.fn.dataTable
    }),
    function (n) {
        ...
        function l(a, t, e) {
            ...
            s = a.cells({
                ...
                .any() || e ? (i = n(e.column, t.column), o(e.row, t.row)) : (i = n(0, t.column), o(0, t.row)), r = a.cells(s, i)
                .flatten(), a.cells(t, {
                    selected: !0
                })
                .any() ? a.cells(r)
        ...
        function o(t) {
            ...
            f(t.table()
                ...
                .off("click.dtSelect", e), f("body")
                .off("click.dtSelect" + t.table()
                    .node()
                    .id)
        }
        ...
        function r(d) {
            ...
            e.on("mousedown.dtSelect", o, function (t) {
                    (t.shiftKey || t.metaKey || t.ctrlKey) && e.css("-moz-user-select", "none")
                ...
                .on("click.dtSelect", o, function (t) {
                    ...
                    if (c) {
                        ...
                        if ((!o.anchorNode || f(o.anchorNode)
                                .closest("table")[0] === d.table()
                                .node()) && o !== c) return
                    }
                    var r = d.settings()[0],
                        a = f.trim(d.settings()[0].oClasses.sWrapper)
                        .replace(/ +/g, ".");
                    if (f(t.target)
                        .closest("div." + a)[0] == d.table()
                        .container()) {
                        var i = d.cell(f(t.target)
                            .closest("td, th"));
                        if (i.any()) {
                            var s = f.Event("user-select.dt");
                            if (m(d, s, [n, i, t]), !s.isDefaultPrevented()) {
                                var l = i.index();
                                "row" === n ? (e = l.row, b(t, d, r, "row", e)) : "column" === n ? (e = i.index()
                                    .column, b(t, d, r, "column", e)) : "cell" === n && (e = i.index(), b(t, d, r, "cell", e)), r._select_lastCell = l
                            }
                        }
                    }
                }), f("body")
                .on("click.dtSelect" + d.table()
                    .node()
                    .id,
                    function (t) {
        ...
        function m(t, e, n, o) {
            o && !t.flatten()
                .length || ("string" == typeof e && (e += ".dt"), n.unshift(t), f(t.table()
                        .node())
                    .trigger(e, n))
        }
        ...
        function a(o) {
            ...
            if (t._select.info && t.aanFeatures.i && "api" !== o.select.style()) {
                var r = o.rows({
                    ...
                    .length,
                    s = function (t, e, n) {
                        t.append(f('<span class="select-item"/>')
                            .append(o.i18n("select." + e + "s", {
                                _: "%d " + e + "s selected",
                                0: "",
                                1: "1 " + e + " selected"
                            }, n)))
        ...
        function d(t, e, n, o) {
            ...
            t[e](n, {
                ...
                .any() ? (r.splice(f.inArray(n, r), 1), t[e + "s"](r)
                    .deselect()) : t[e + "s"](r)
                .select()
        }
        ...
        function b(t, e, n, o, r) {
            ...
            if ("os" === a)
                ...
                i && 1 === s.flatten()
                    .length ? e[o](r)
                    .deselect() : (s.deselect(), e[o](r)
                        .select())
            } else "multi+shift" == a && t.shiftKey ? "cell" === o ? l(e, r, n._select_lastCell || null) : d(e, o, r, n._select_lastCell ? n._select_lastCell[o] : null) : e[o](r)
                .select(!i)
        }
        p.select = {}, p.select.version = "1.3.0", p.select.init = function (t) {
            ...
            e._select = {}, !0 === r ? (i = "os", u = !0) : "string" == typeof r ? (i = r, u = !0) : f.isPlainObject(r) && (r.blurable !== h && (s = r.blurable), r.info !== h && (l = r.info), r.items !== h && (a = r.items), u = (i = r.style !== h ? r.style : "os", !0), r.selector !== h && (d = r.selector), r.className !== h && (c = r.className)), t.select.selector(d), t.select.items(a), t.select.style(i), t.select.blurable(s), t.select.info(l), e._select.className = c, f.fn.dataTable.ext.order["select-checkbox"] = function (e, t) {
                    return this.api()
                        ...
                        .nodes()
                        .map(function (t) {
                            return "row" === e._select.items ? f(t)
                                .parent()
                                .hasClass(e._select.className) : "cell" === e._select.items && f(t)
                                .hasClass(e._select.className)
                        })
                }, !u && f(t.table()
                    .node())
                .hasClass("selectable") && t.select.style("os")
        }, f.each([{
            type: "row",
            prop: "aoData"
        }, {
        ...
        e("select()", function () {
                ...
                t._select.style = n, t._select_init || function (i) {
                    ...
                    i.aoRowCreatedCallback.push({
                        fn: function (t, e, n) {
                            ...
                            for (a._select_selected && f(t)
                                .addClass(i._select.className), o = 0, r = i.aoColumns.length; o < r; o++)(i.aoColumns[o]._select_selected || a._selected_cells && a._selected_cells[o]) && f(a.anCells[o])
                                .addClass(i._select.className)
                        },
                        ...
                        n.one("draw.dt.dtSelect", function () {
                            n.rows(t)
                                .select(), e.any() && e.each(function (t) {
                                    n.cells(t.row, t.column)
                                        .select()
                                })
                        })
            ...
            return !1 === t ? this.deselect() : (this.iterator("row", function (t, e) {
                i(t), t.aoData[e]._select_selected = !0, f(t.aoData[e].nTr)
                    .addClass(t._select.className)
            }), this.iterator("table", function (t, e) {
            ...
            return !1 === t ? this.deselect() : (this.iterator("column", function (t, e) {
                ...
                var n = new p.Api(t)
                    .column(e);
                f(n.header())
                    .addClass(t._select.className), f(n.footer())
                    .addClass(t._select.className), n.nodes()
                    .to$()
                    .addClass(t._select.className)
            }), this.iterator("table", function (t, e) {
            ...
            return !1 === t ? this.deselect() : (this.iterator("cell", function (t, e, n) {
                i(t);
                var o = t.aoData[e];
                o._selected_cells === h && (o._selected_cells = []), o._selected_cells[n] = !0, o.anCells && f(o.anCells[n])
                    .addClass(t._select.className)
            }), this.iterator("table", function (t, e) {
            ...
            var n = this;
            return this.iterator("row", function (t, e) {
                t.aoData[e]._select_selected = !1, f(t.aoData[e].nTr)
                    .removeClass(t._select.className)
            }), this.iterator("table", function (t, e) {
            ...
            return this.iterator("column", function (o, t) {
                ...
                var e = new p.Api(o),
                    n = e.column(t);
                f(n.header())
                    .removeClass(o._select.className), f(n.footer())
                    .removeClass(o._select.className), e.cells(null, t)
                    .indexes()
                    .each(function (t) {
                        var e = o.aoData[t.row],
                            n = e._selected_cells;
                        !e.anCells || n && n[t.column] || f(e.anCells[t.column])
                            .removeClass(o._select.className)
                    })
            }), this.iterator("table", function (t, e) {
            ...
            return this.iterator("cell", function (t, e, n) {
                var o = t.aoData[e];
                o._selected_cells[n] = !1, o.anCells && !t.aoColumns[n]._select_selected && f(o.anCells[n])
                    .removeClass(t._select.className)
            }), this.iterator("table", function (t, e) {
        ...
        return f.extend(p.ext.buttons, {
            ...
            .on("preInit.dt.dtSelect", function (t, e) {
    ...
    function (n) {
        "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-select"], function (t) {
            ...
            return t = t || window, e && e.fn.dataTable || (e = require("datatables.net-bs4")(t, e)
                .$), e.fn.dataTable.select || require("datatables.net-select")(t, e), n(e, t, t.document)
        } : n(jQuery, window, document)
    }(function (t, e, n, o) {
        return t.fn.dataTable
    }),
        ...
        return c.extend(s.prototype, {
                _constructor: function () {
                    ...
                    e.settings()[0].oInit.onAddRow && (t.onAddRow = e.settings()[0].oInit.onAddRow), e.settings()[0].oInit.onDeleteRow && (t.onDeleteRow = e.settings()[0].oInit.onDeleteRow), e.settings()[0].oInit.onEditRow && (t.onEditRow = e.settings()[0].oInit.onEditRow), this._setup(), e.on("destroy.altEditor", function () {
                        e.off(".altEditor"), c(e.table()
                                .body())
                            .off(t.s.namespace), c(n.body)
                            .off(t.s.namespace)
                    })
                },
                _setup: function () {
                    ...
                    c("body")
                        .append(n), t.button("edit:name") && (t.button("edit:name")
                            .action(function (t, e, n, o) {
                                r._openEditModal()
                            }), c(this.modal_selector)
                            .on("click", "#editRowBtn", function (t) {
                                r._inputValidation() && (t.preventDefault(), t.stopPropagation(), r._editRowData())
                            })), t.button("delete:name") && (t.button("delete:name")
                            .action(function (t, e, n, o) {
                                r._openDeleteModal()
                            }), c(this.modal_selector)
                            .on("click", "#deleteRowBtn", function (t) {
                                t.preventDefault(), t.stopPropagation(), r._deleteRow(), c(this)
                                    .prop("disabled", !0)
                            })), t.button("add:name") && (t.button("add:name")
                            .action(function (t, e, n, o) {
                                r._openAddModal()
                            }), c(this.modal_selector)
                            .on("click", "#addRowBtn", function (t) {
                                r._inputValidation() && (t.preventDefault(), t.stopPropagation(), r._addRowData())
                            })), this.s.dt.button("refresh:name") && this.s.dt.button("refresh:name")
                        .action(function (t, e, n, o) {
                ...
                _openEditModal: function () {
                    ...
                    for (var s in c(d)
                            .on("show.bs.modal", function () {
                                c(d)
                                    .find(".modal-title")
                                    .html("Edit Record"), c(d)
                                    .find(".modal-body")
                                    .html(i), c(d)
                                    .find(".modal-footer")
                                    .html('<button type="button" data-content="remove" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" data-content="remove" class="btn btn-primary" id="editRowBtn">Save</button>')
                            }), c(d)
                            .modal("show"), c(d + " input[0]")
                            .focus(), n) n[s].select2 && c(d)
                        .find("select#" + n[s].name)
                        .select2(n[s].select2);
                    for (var s in n) n[s].datepicker && c(d)
                        .find("#" + n[s].name)
                ...
                _openDeleteModal: function () {
                    ...
                    c(i)
                        .on("show.bs.modal", function () {
                            c(i)
                                .find(".modal-title")
                                .html("Delete Record"), c(i)
                                .find(".modal-body")
                                .html(r), c(i)
                                .find(".modal-footer")
                                .html('<button type="button" data-content="remove" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button"  data-content="remove" class="btn btn-danger" id="deleteRowBtn"><i class="fal fa-times"></i> Delete</button>')
                        }), c(i)
                        .modal("show"), c(i + " input[0]")
                        .focus()
                },
                _deleteRow: function () {
                    ...
                    for (var i in c(l)
                            .on("show.bs.modal", function () {
                                c(l)
                                    ...
                                    .html(a), c(l)
                                    .find(".modal-footer")
                                    .html('<button type="button" data-content="remove" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button"  data-content="remove" class="btn btn-primary" id="addRowBtn">Add</button>')
                            }), c(l)
                            .modal("show"), c(l + " input[0]")
                            .focus(), n) n[i].select2 && c(l)
                ...
                _deleteRowCallback: function (t, e, n) {
                    ...
                    c(o + " .modal-body .alert")
                        .remove();
                    c(o + " .modal-body")
                        .append('<div class="alert alert-success" role="alert"><strong>Success!</strong></div>'), this.s.dt.row({
                            selected: !0
                        })
                        .remove(), this.s.dt.draw(), c("div" + o)
                        .find("button#addRowBtn")
                        .prop("disabled", !0), c("div" + o)
                ...
                _addRowCallback: function (t, e, n) {
                    ...
                    c(r + " .modal-body .alert")
                        .remove();
                    c(r + " .modal-body")
                        .append('<div class="alert alert-success" role="alert"><strong>Success!</strong></div>'), this.s.dt.row.add(o)
                        .draw(!1), c("div" + r)
                        .find("button#addRowBtn")
                        .prop("disabled", !0), c("div" + r)
                        .find("button#editRowBtn")
                        .prop("disabled", !0), c("div" + r)
                        .find("button#deleteRowBtn")
                        .prop("disabled", !0), c(r)
                ...
                _editRowCallback: function (t, e, n) {
                    ...
                    c(r + " .modal-body .alert")
                        .remove();
                    c(r + " .modal-body")
                        .prepend('<div class="alert alert-success" role="alert"><strong>Success!</strong></div>'), this.s.dt.row({
                            selected: !0
                        })
                        .data(o), this.s.dt.draw(), c("div" + r)
                        .find("button#addRowBtn")
                        .prop("disabled", !0), c("div" + r)
                        .find("button#editRowBtn")
                        .prop("disabled", !0), c("div" + r)
                ...
                _inputValidation: function () {
                    var a = this.s.dt,
                        t = !1,
                        i = 0;
                    return c('form[name="altEditor-form"] *')
                        .filter(":text")
                        .each(function (t) {
                            var e = "#" + c(this)
                                .attr("id") + "label";
                            if (c(e)
                                ...
                                if ("true" == c(this)
                                    .attr("data-unique")) {
                                    var n = a.column("th:contains('" + c(this)
                                            .attr("name") + "')")
                                        .data(),
                                        o = null;
                                    for (var r in null != a.row({
                                            ...
                                            .index() && (o = a.cell(a.row({
                                                    ...
                                                    .index(), a.column("th:contains('" + c(this)
                                                        .attr("name") + "')")
                                                    .index())
                                                .data()), n) c(this)
                                        .val() == n[r] && n[r] != o && (c(e)
                                            .html(c(this)
                                                .attr("data-uniqueMsg")), c(e)
                                            .show(), i++)
                                }
                            } else c(e)
                                .html(c(this)
                                    .attr("data-errorMsg")), c(e)
                                .show(), i++
                        }), 0 == i && (t = !0), t
                },
            ...
            .on("preInit.dt.altEditor", function (t, e, n) {
                if ("dt" === t.namespace) {
