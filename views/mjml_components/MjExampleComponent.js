...
mjmlValidator.registerDependencies({
    // Tell the validator which tags are allowed as our component's parent
    'mj-hero': ['mj-example-component'],
    'mj-column': ['mj-example-component'],

    // Tell the validator which tags are allowed as our component's children
    'mj-example-component': []
});


class MjExampleComponent extends mjmlCore.BodyComponent {
...
MjExampleComponent.endingTag = true

// Tells the validator which attributes are allowed for mj-layout
MjExampleComponent.allowedAttributes = {
    'stars-color': 'color',
    'color': 'color',
    'font-size': 'unit(px)',
...
MjExampleComponent.defaultAttributes = {
    'stars-color': 'yellow',
    color: 'black',
    'font-size': '12px',
    'align': 'center',
...
module.exports = MjExampleComponent;